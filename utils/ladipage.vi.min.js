...
var equalsLadiPage = function(t, e) {
  ...
  , LadiPageTrackingCommand = {
    push: function(t, e) {
        isFunctionLadiPage(t) && isFunctionLadiPage(e) && (t() ? e() : LadiPageTrackingCommandList.push({
            callback1: t,
            callback2: e
        }))
    }
...
LadiPageScriptV2.prototype.loadDataset = function(t, e, i, a, n, o, r, d) {
    isArrayLadiPage(this.runtime.list_dataset_load) && this.runtime.list_dataset_load.push({
        element_id: t,
        dataset_id: e,
        dataset_type: i,
        sort_name: a,
...
LadiPageScriptV2.prototype.loadHtmlGlobal = function(t) {
    for (var e = this, i = 0, a = [], n = document.querySelectorAll(".ladi-section"), o = 0; o < n.length; o++) {
        var r = n[o]
          , d = r.getAttribute("data-global-id");
        isEmptyLadiPage(d) || a.push({
            id: r.id,
            data_global_id: d
        })
    }
    var s = function(n) {
        ...
        i == a.length && function(t) {
            for (var i = [], a = document.querySelectorAll("div.ladi-section-global[data-country-file]"), n = 0; n < a.length; n++) {
                ...
                isEmptyLadiPage(o) || (o = (o = o.split(";")).removeSpace(),
                i = i.concat(o))
            }
            if ((i = i.unique()).length > 0 && e.runtime.hasOwnProperty("cdn_url") && e.runtime.hasOwnProperty("version")) {
                ...
                i.forEach(function(a) {
                    ...
                    e.loadScript(n, null, !0, function(a) {
                        ++r < i.length || (e.runtime.load_location || (e.runtime.load_location = !0,
                        e.runAfterLocation()),
            ...
            document.querySelectorAll('.ladi-section-global[data-dataset="true"]').length > 0 && !e.runtime.has_dataset && (e.runtime.has_dataset = !0,
            e.runtime.hasOwnProperty("cdn_url") && e.runtime.hasOwnProperty("version") && e.loadScript(e.runtime.cdn_url + "dataset.min.js?v=" + e.runtime.version)),
...
LadiPageScriptV2.prototype.updateHeightElement = function(t, e, i, a, n, o) {
    ...
    if (a != n) {
        var d = "style_update_height_element"
          , s = !0;
        if ("fixed" == getComputedStyle(e).position && (s = !1),
        t) {
        ...
        if (!isEmptyLadiPage(i) && i.id != r.runtime.builder_section_popup_id) {
            ...
            if ((i.classList.contains("ladi-section") || i.getElementsByClassName("ladi-popup").length > 0) && (P = v + g),
            m(i, "height", P - v),
            s) {
                var h = (c = i,
        ...
        if (e == a.const.VIDEO_TYPE.youtube) {
            ...
            if (a.runtime.isYouTubeIframeAPIReady) {
                ...
                if (!isEmptyLadiPage(l)) {
                    if (d && i && isFunctionLadiPage(l.unMute) && l.unMute(),
                    !d && i && isFunctionLadiPage(l.mute) && l.mute(),
                    !isFunctionLadiPage(l[o]))
            ...
            s || (d && i && a.postMessageWindow(n.contentWindow, {
                event: "command",
                func: "unMute",
                args: []
            }, "*"),
    ...
    if (!isEmptyLadiPage(m)) {
        ...
        if (!isEmptyLadiPage(g)) {
            ...
            if (!isEmptyLadiPage(y)) {
                ...
                f.toLowerCase().startsWith('url("') && f.toLowerCase().endsWith('")') && (f = (f = f.substr('url("'.length)).substr(0, f.length - '")'.length),
        ...
        if (e == c.const.VIDEO_TYPE.direct) {
            ...
            (n || a || s || u) && (m.setAttribute("playsinline", ""),
    ...
    if (!isEmptyLadiPage(r)) {
        ...
        isEmptyLadiPage(d)) {
            var s = r.getElementsByClassName("ladi-video")[0]
              , l = t + "_player";
            e == this.const.VIDEO_TYPE.youtube && (s.innerHTML = s.innerHTML + '<iframe id="' + l + '" class="iframe-video-preload" data-video-type="' + e + '" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0;" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
            this.runEventPlayVideo(l, e, i, n, !1, a, o)),
            e == this.const.VIDEO_TYPE.direct && (s.innerHTML = s.innerHTML + '<video id="' + l + '" class="iframe-video-preload" data-video-type="' + e + '" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; object-fit: cover;"></video>',
            this.runEventPlayVideo(l, e, i, n, !1, a, o))
        } else
...
LadiPageScriptV2.prototype.getOptimizeImage = function(t, e, i, a, n, o, r) {
    ...
    var d = t.split("/")
      , s = d.indexOf("");
    if (-1 != s && d.length > s + 1 && (d[s + 1] = d[s + 1].toLowerCase()),
...
LadiPageScriptV2.prototype.resetViewport = function() {
    isEmptyLadiPage(this.runtime.tmp.timeoutViewport) || this.removeTimeout(this.runtime.tmp.timeoutViewport),
    isFunctionLadiPage(window.ladi_viewport) && (this.runtime.tmp.timeoutViewport = this.runTimeout(window.ladi_viewport, 10))
}
,
        ...
        if (!isEmptyLadiPage(i)) {
            ...
            if (0 != n.length) {
                ...
                function(e, i) {
                    ...
                    s.style.setProperty("width", "calc(100% / " + n.length + " - 10px)"),
                    r(s, n[d]),
                    a.appendChild(s),
                    0 == d && (o = s)
                }
        ...
        for (var e = document.querySelectorAll(".ladi-section .ladi-section-background iframe.ladi-section-background-video"), i = 0; i < e.length; i++) {
            ...
            if (!(n <= 0 || o <= 0)) {
                var r = t.findAncestor(a, "ladi-section-background")
                  , d = r.clientWidth
                  , s = o / n * d;
                s < r.clientHeight && (d = r.clientHeight / s * d,
                s = r.clientHeight);
...
LadiPageScriptV2.prototype.runResizeAll = function() {
    ...
    try {
        ...
        for (var e = document.querySelectorAll("#" + t.runtime.builder_section_popup_id + " .ladi-container > .ladi-element"), i = 0; i < e.length; i++)
            "none" != getComputedStyle(e[i]).display && (t.runtime.tmp.is_resize_all = !0,
...
LadiPageScriptV2.prototype.runAfterLocation = function() {
    ...
    t.runtime.isRun) {
        ...
        t.runTimeout(t.runAfterLocation, 100)
}
,
        ...
        if (t && isObjectLadiPage(e.runtime.story_page)) {
            ...
            for (var d = document.querySelectorAll(".ladi-gallery .ladi-gallery-view-item.selected:not(.ladi-lazyload)"), s = 0; s < d.length; s++)
                if (isEmptyLadiPage(d[s].getAttribute("data-lazyload"))) {
                    ...
                    for (var l = d[s].parentElement.getElementsByClassName("ladi-lazyload"); l.length > 0; )
...
LadiPageScriptV2.prototype.documentLoaded = function() {
        ...
        if (!isEmptyLadiPage(r) && !isEmptyLadiPage(d)) {
            ...
            if (s > 0 && isArrayLadiPage(d.dynamic_content.cookie)) {
                ...
                d.dynamic_content.cookie.forEach(function(t) {
                    var e = t.split("=");
                    2 != (e = e.removeSpace()).length || isEmptyLadiPage(e[0]) || isEmptyLadiPage(e[1]) || l.push({
                        name: e[0],
                        value: e[1]
                    })
                }),
    ...
    u.length > 0 && !isEmptyLadiPage(o))
        try {
            ...
            isEmptyLadiPage(c) || isEmptyLadiPage(c.id) || !c.classList.contains("ladi-section") || (window.ladi(c.id).scroll(!1, !0),
            o = null)
        } catch (t) {}
...
LadiPageScriptV2.prototype.startAutoScroll = function(t, e, i, a) {
    if (this.runtime.isDesktop ? i : a) {
        ...
        if (!isEmptyLadiPage(n) && !n.classList.contains("ladi-auto-scroll")) {
            var o = 0;
            if ("section" != e) {
                if (n.clientWidth <= this.getWidthDevice())
                    return;
    ...
    var r = this
      , d = function(s) {
        var l = s[e]
          , c = function(s, u) {
            if (l.list.length <= s)
                0 == s ? d({}) : isFunctionLadiPage(o) && o(r.const.LANG.REQUEST_SEND_ERROR, 0, u, e);
            else {
                var p = {};
                p.timeout = l.timeout,
...
LadiPageScriptV2.prototype.sendRequestWithOption = function(t, e, i, a, n, o, r) {
    ...
    if (isFunctionLadiPage(this.runtime.send_request_response[e]) && this.runtime.send_request_response[e](e, i, r))
        return;
...
LadiPageScriptV2.prototype.runEventMouseMove = function(t) {
    ...
    if (!isEmptyLadiPage(e.runtime.current_element_mouse_down_gallery_view)) {
        i = document.querySelector('[data-runtime-id="' + e.runtime.current_element_mouse_down_gallery_view + '"]'),
    ...
    (n += a) < (o = (parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control")[0]).width) || 0) - (parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control-box")[0]).width) || 0)) && (n = o),
    n > 0 && (n = 0),
...
LadiPageScriptV2.prototype.runEventMouseUp = function(t) {
    ...
    if (!isEmptyLadiPage(e.runtime.current_element_mouse_down_carousel)) {
        ...
        a >= e.runtime.current_element_mouse_down_carousel_diff ? i.getElementsByClassName("ladi-carousel-arrow-left")[0].click() : a <= -e.runtime.current_element_mouse_down_carousel_diff ? i.getElementsByClassName("ladi-carousel-arrow-right")[0].click() : i.getElementsByClassName("ladi-carousel-content").length > 0 && (i.getElementsByClassName("ladi-carousel-content")[0].style.setProperty("transition-duration", "100ms"),
        i.getElementsByClassName("ladi-carousel-content")[0].style.setProperty("left", n),
        e.runTimeout(function() {
            i.getElementsByClassName("ladi-carousel-content")[0].style.removeProperty("transition-duration")
        }, 1))
    }
    if (isEmptyLadiPage(e.runtime.current_element_mouse_down_gallery_view) || (i = document.querySelector('[data-runtime-id="' + e.runtime.current_element_mouse_down_gallery_view + '"]')).querySelectorAll(".ladi-gallery-view-item.selected").length > 0 && i.querySelectorAll(".ladi-gallery-view-item.selected")[0].style.removeProperty("left"),
...
LadiPageScriptV2.prototype.runEventScroll = function(t) {
    ...
    e.runtime.isRun) {
        if (!isEmptyLadiPage(e.runtime.eventData) && !e.runtime.tmp.is_run_show_popup) {
            ...
            var o = [];
            if (!isEmptyLadiPage(i))
                for (var r = document.querySelectorAll("#" + i + " .ladi-element"), d = 0; d < r.length; d++)
                    o.push(r[d].id);
            if (Object.keys(e.runtime.eventData).forEach(function(t) {
                ...
                for (var c = 0; c < l.length; c++)
                    ...
                    !isEmptyLadiPage(d)) {
                        ...
                        if (-1 != s.indexOf(u)) {
                            ...
                            p && (r = e.runtime.list_scroll_func[u],
                ...
                !isEmptyLadiPage(d) && !d.classList.contains("ladi-animation"))) {
                    ...
                    _ && (d.classList.add("ladi-animation"),
                    e.runTimeout(function() {
                ...
                if (isEmptyLadiPage(i) || -1 != o.indexOf(t)) {
                    var y = null
                      , f = null
                      , v = null;
                    if (a[e.runtime.device + ".option.sticky"] && (y = a[e.runtime.device + ".option.sticky_position"],
                    ...
                    !e.runtime.has_popupx && !isEmptyLadiPage(y)) {
                        ...
                        if (!isEmptyLadiPage(P) && P.clientWidth > 0 && P.clientHeight > 0 && -1 != ["default", "top", "bottom"].indexOf(y)) {
                            ...
                            isEmptyLadiPage(L) ? (P.setAttribute("data-top", h.y + window.scrollY),
                            L = h.y) : L = parseFloatLadiPage(L),
                            isEmptyLadiPage(E) ? (P.setAttribute("data-left", h.x + window.scrollX),
                            E = h.x) : E = parseFloatLadiPage(E);
                            var b = null
                              , A = null
                              , w = e.getHeightDevice()
                              ...
                              , C = 0
                              , N = 0;
                            if ("default" == y && (f >= L - window.scrollY ? (b = f + "px",
                            A = E + "px",
                            f <= 0 && (S = P.clientHeight),
                            C = P.clientHeight) : w - v - P.clientHeight <= L - window.scrollY && (b = "calc(100% - " + (v + P.clientHeight) + "px)",
                            A = E + "px",
                            v <= 0 && (O = P.clientHeight),
                            N = P.clientHeight)),
                            "top" == y && (f >= L - window.scrollY || w - 0 < L - window.scrollY) && (b = f + "px",
                            A = E + "px",
                            f <= 0 && (S = P.clientHeight),
                            C = P.clientHeight),
                            "bottom" == y && (w - v - P.clientHeight <= L - window.scrollY || 0 > L + P.clientHeight - window.scrollY) && (b = "calc(100% - " + (v + P.clientHeight) + "px)",
                            A = E + "px",
                            v <= 0 && (O = P.clientHeight),
                            N = P.clientHeight),
                            isEmptyLadiPage(b) || isEmptyLadiPage(A))
                                ...
                                T.getAttribute("data-padding-top-id") == t && (T.removeAttribute("data-padding-top-id"),
                                T.style.removeProperty("padding-top")),
                                T.getAttribute("data-padding-bottom-id") == t && (T.removeAttribute("data-padding-bottom-id"),
                                T.style.removeProperty("padding-bottom"));
                            else if ("section" == a.type && (e.runtime.is_mobile_only ? P.style.setProperty("width", T.clientWidth + "px") : e.runtime.isDesktop && P.style.setProperty("width", "100%"),
                            S > 0 && (T.setAttribute("data-padding-top-id", t),
                            T.style.setProperty("padding-top", S + "px")),
                            O > 0 && (T.setAttribute("data-padding-bottom-id", t),
                            T.style.setProperty("padding-bottom", O + "px")),
                            ...
                            !P.hasAttribute("data-sticky")) {
                                ...
                                for (var k = P.getElementsByClassName("ladi-animation-hidden"); k.length > 0; )
                                    k[0].classList.add("ladi-animation"),
                                    k[0].classList.remove("ladi-animation-hidden");
                                P.classList.remove("ladi-lazyload");
                                for (var I = P.getElementsByClassName("ladi-lazyload"); I.length > 0; )
                                    I[0].classList.remove("ladi-lazyload")
                            }
                        }
                    }
                ...
                if ("popup" == a.type) {
                    if (!isEmptyLadiPage(e.runtime.scroll_show_popup[t]))
                        return;
                    isEmptyLadiPage(a["option.popup_welcome_page_scroll_to"]) || (d = document.getElementById(a["option.popup_welcome_page_scroll_to"]),
                ...
                if ("section" == a.type) {
                    ...
                    isEmptyLadiPage(d) || (n = d.offsetTop,
            ...
            e.runtime.isClient) {
                ...
                for (var s = Math.round((window.scrollY + e.getHeightDevice()) / document.body.clientHeight * 100), l = function(t) {
                    LadiPageTrackingCommand.push(function() {
                        ...
                        e.runLadiPageCommand(function(e) {
                            if (e.tiktokViewContent && t >= e.scrollPercent)
                                return window.ttq.track(e.name),
                                !0
                        })
                    })
                }, c = function(t) {
                    ...
                    s > e.const.PERCENT_TRACKING_SCROLL[p - 1] && s <= m && -1 == e.runtime.scroll_depth.indexOf(m) && (e.runtime.scroll_depth.push(m),
                    c(m),
                    u(m),
                    l(s))
                }
            ...
            !isEmptyLadiPage(t)) {
                ...
                e.runtime.tmp.timeout_scrolling_id = e.runTimeout(function() {
                    ...
                    _ = Object.values(e.runtime.list_scrolled_exec),
                    g = 0; g < _.length; g++)
                        _[g]()
                }, 1e3)
            }
...
LadiPageScriptV2.prototype.runRemovePopup = function(t, e, i, a, n) {
    ...
    if (c.forEach(function(t) {
        ...
        if (!isEmptyLadiPage(i)) {
            o.runtime.has_popupx && ("none" != getComputedStyle(i).display && (s = !0),
...
LadiPageScriptV2.prototype.runShowPopup = function(t, e, i, a, n) {
    ...
    if (!isEmptyLadiPage(e)) {
        ...
        if (!n || !isEmptyLadiPage(r) && isObjectLadiPage(o.runtime.eventData) && !isEmptyLadiPage(o.runtime.eventData[e])) {
            n && (i = o.runtime.eventData[e][o.runtime.device + ".option.popup_position"],
            a = o.runtime.eventData[e][o.runtime.device + ".option.popup_backdrop"]);
            var d = function(t) {
                o.runtime.tmp.is_run_show_popup = !0;
                var s = 0
                  , l = "";
                n || LadiPagePlugin.getPlugin("popup").showStyleShowPopupBuilder(e);
                isEmptyLadiPage(a) ? l += n ? "#" + o.runtime.backdrop_popup_id + " { display: none !important;}" : "#" + o.runtime.backdrop_popup_id + " { display: block !important;}" : (l += "#" + o.runtime.backdrop_popup_id + " { display: block !important; " + a + "}",
                r.setAttribute("data-popup-backdrop", !0)),
                i == o.const.POSITION_TYPE.default && "true" != r.getAttribute("data-dropbox") && (!function() {
                ...
                o.removeTimeout(f),
                !n || "true" == r.getAttribute("data-dropbox") || o.runtime.tmp.is_resize_all || o.runtime.tmp.is_wait_popup || isEmptyLadiPage(r.style.getPropertyValue("max-height")) && r.style.setProperty("visibility", "hidden"),
                ...
                t && (!u && r.clientHeight > .8 * o.getHeightDevice() && (n ? o.runtime.has_popupx ? m = !0 : (r.setAttribute("data-scroll", !0),
                r.style.setProperty("overflow-y", "auto", "important"),
                r.style.setProperty("overflow-x", "hidden", "important"),
                u = !0) : p = !0),
                o.runtime.has_popupx && (m ? (r.setAttribute("data-fixed-close", !0),
                document.body.style.setProperty("height", r.clientHeight + "px")) : document.body.style.removeProperty("height")),
                u && n && (r.getElementsByClassName("ladi-popup")[0].style.removeProperty("height"),
                ...
                o.runtime.has_popupx && (l += n ? "#" + o.runtime.backdrop_popup_id + " { display: none !important;}" : "#" + o.runtime.backdrop_popup_id + " { display: block !important;}",
                r.style.removeProperty("max-height"),
                ...
                if (n && !isEmptyLadiPage(r) && "true" != r.getAttribute("data-dropbox")) {
                    ...
                    o.removeTimeout(f),
                    "true" == r.getAttribute("data-scroll") && (P.style.removeProperty("right"),
                    P.style.removeProperty("top"),
                    P.style.removeProperty("position")),
                    o.runtime.has_popupx && o.runtime.tmp.popupx_is_inline && P.classList.add("ladi-hidden");
                    var h = function() {
                        if (P = r.getElementsByClassName("popup-close")[0],
                        !isEmptyLadiPage(P))
                    ...
                    ,
                    (u || m) && (r.hasAttribute("data-resize-scroll") || (r.setAttribute("data-resize-scroll", !0),
                    window.addEventListener("resize", h)))
                }
                n && !c && o.runEventTracking(e, {
                    is_form: !1
                });
                var L = function() {
                    var t = s;
                ...
                if (t)
                    ...
                    f = o.runTimeout(function() {
                        "none" == getComputedStyle(r).display ? (s -= 100,
                        L()) : d(!0),
                        r.removeAttribute("data-timeout-id-2")
                    }, 100),
...
LadiPageScriptV2.prototype.runEventTracking = function(t, e, i, a, n) {
    ...
    if (this.runtime.isClient) {
        ...
        if (y)
            ...
            o.runtime.shopping && (c = o.getCartCheckoutPrice(c))) : (r = p["option.conversion_name"],
            d = p["option.google_ads_conversion"],
            s = p["option.google_ads_label"],
            l = p["option.event_custom_script"])
        }
        var f = function(t) {
            var e = null
              , a = null
            ...
            d.forEach(function(e) {
                ...
                isObjectLadiPage(i) && (isObjectLadiPage(a) || (a = {}),
                a.email = i.email,
                a.phone = i.phone),
                s = [{
          ...
          , v = function(t) {
            if (isObjectLadiPage(i)) {
                ...
                Object.keys(n).length > 0 && LadiPageTrackingCommand.push(function() {
                    return isFunctionLadiPage(window.gtag)
                }, function() {
                    window.gtag("set", "user_data", n)
                })
            }
            isEmptyLadiPage(d) || isEmptyLadiPage(s) || (t ? o.runtime.tmp.runActionPopupX({
            ...
            if (!isEmptyLadiPage(r)) {
                ...
                isEmptyLadiPage(c) || isEmptyLadiPage(u) || (l.value = c,
                l.currency = u),
                t ? o.runtime.tmp.runActionPopupX({
                    conversion_name: r,
                    gtag_data: l,
          ...
          , P = function(t) {
            var e = null;
            if (isObjectLadiPage(i) && (e = {
                email: i.email,
                phone_number: o.convertPhoneNumberFormData(i.phone)
            }),
            isObjectLadiPage(e) && !isEmptyLadiPage(e.phone_number) && (t ? o.runtime.tmp.runActionPopupX({
                ttq_identify_data: e,
                action: {
            ...
            !isEmptyLadiPage(r)) {
                if (-1 != ["Purchase", "Lead"].indexOf(r))
                    return;
                var a = null;
                "CompletePayment" != r || isEmptyLadiPage(c) || isEmptyLadiPage(u) || ((a = {
            ...
            _ && (o.runLadiPageCommand(function(e) {
                if (e.tiktokViewContent && e.clickButton)
                    return t ? o.runtime.tmp.runActionPopupX({
        ...
        if (!isEmptyLadiPage(a)) {
            var h = !1;
            return isEmptyLadiPage(d) || isEmptyLadiPage(s) || (h = !0),
            isEmptyLadiPage(r) || (h = !0),
            isEmptyLadiPage(l) || (h = !0),
            _ && (h = !0),
            -1 != ["section", "popup", "countdown"].indexOf(m) && (h = !1),
            void (h && a.addEventListener("click", function(r) {
        ...
        v(),
        P(),
        isEmptyLadiPage(l) || o.runFunctionString(l)
    }
}
,
...
LadiPageScriptV2.prototype.convertReplacePrefixStr = function(t, e) {
    ...
    for (var s = new RegExp(a + "[^" + a + "$" + n + "]*" + n,"gi"), l = null, c = function(t) {
        ...
        l.index === s.lastIndex && s.lastIndex++,
        l.forEach(c);
    return i
}
,
...
LadiPageScriptV2.prototype.convertDataReplaceStr = function(t, e, i, a, n, o) {
    ...
    r.runtime.convert_replace_str && (d = r.runtime.replaceNewPrefixStart,
    ...
    for (var l = t = isEmptyLadiPage(t) ? "" : t, c = new RegExp(d + "[^" + d + "$" + s + "]*" + s,"gi"), u = null, p = [], m = function(t) {
        if (a)
            ...
            var i = t
              , c = i.split("|");
            i = c[0].substr(d.length),
            1 == c.length && (i = i.substr(0, i.length - s.length));
            var u = r.getDataReplaceStr(i, n);
            if (isEmptyLadiPage(u))
                if (c.length > 1) {
                    var m = r.randomInt(1, c.length - 1);
                    u = c[m],
                    m == c.length - 1 && (u = u.substr(0, u.length - s.length))
                } else
                    u = "";
            e && (isArrayLadiPage(u) && u.length > 1 && (u = JSON.stringify(u)),
            u = encodeURIComponent(u)),
            l = o && isArrayLadiPage(u) && u.length > 1 ? u : l.replaceAll(t, u)
        }
    }; null !== (u = c.exec(t)); )
        u.index === c.lastIndex && c.lastIndex++,
        u.forEach(m);
    return p = p.unique(),
...
LadiPageScriptV2.prototype.setDataReplaceElement = function(t, e, i, a, n) {
    ...
    if (!isEmptyLadiPage(o)) {
        ...
        for (var p = o.querySelectorAll(".ladi-element .ladi-form-item-container [name]"), m = 0; m < p.length; m++) {
            ...
            if (v = isEmptyLadiPage(v) ? v : v.trim(),
            t) {
                var P = p[m].getAttribute("name").trim();
                (y = !0) && -1 == n.indexOf(P) && (y = !1),
                y && "country" == P && "true" == p[m].getAttribute("data-is-select-country") && (y = !1),
                y && (g = this.getDataReplaceStr(P, i))
            }
            if (!y) {
                if (f = this.findAncestor(p[m], "ladi-element"),
                isEmptyLadiPage(f))
                    continue;
            ...
            if (!isNullLadiPage(g)) {
                ...
                "INPUT" == p[m].tagName)
                    if ("checkbox" == v || "radio" == v) {
                        ...
                        "radio" == v && (b = p[m].getAttribute("value") == _.trim()),
                        b ? (p[m].checked = !0,
                        ...
                        (isEmptyLadiPage(f) || "true" != f.getAttribute("data-quantity")) && (p[m].value = _.trim(),
                ...
                "SELECT" == p[m].tagName) {
                    ...
                    e && !S.hasAttribute("selected"))) {
                        for (var O = p[m].querySelectorAll("option"), C = 0; C < O.length; C++)
...
LadiPageScriptV2.prototype.showMessage = function(t, e, i) {
    if (t = this.convertDataReplaceStr(t, !1, null, !1, e),
...
LadiPageScriptV2.prototype.getCountdownTime = function(t, e) {
    ...
    s = s < 10 ? "0" + s : s;
    var l = {};
    return l[this.const.COUNTDOWN_ITEM_TYPE.day] = o,
    l[this.const.COUNTDOWN_ITEM_TYPE.hour] = r,
    l[this.const.COUNTDOWN_ITEM_TYPE.minute] = d,
    l[this.const.COUNTDOWN_ITEM_TYPE.seconds] = s,
    isEmptyLadiPage(e) ? l : l[e]
}
,
...
LadiPageScriptV2.prototype.run = function(t) {
    ...
    if (e.runtime.isLoadHtmlGlobal) {
        ...
        e.runtime.isIE = e.runtime.isIE ? e.runtime.isIE : !e.runtime.isIE && !!window.StyleMedia,
        ...
        isEmptyLadiPage(e.runtime.timenow) ? (e.runtime.timenow = Date.now(),
        window.ladi("_timenow").set_cookie(e.runtime.timenow, 1)) : e.runtime.timenow = parseFloatLadiPage(e.runtime.timenow) || 0;
        try {
        ...
        isNullLadiPage(window.ladi_is_desktop) ? e.runtime.isDesktop = t ? !/android|webos|iphone|ipad|ipod|blackberry|iemobile|opera mini/i.test(window.navigator.userAgent.toLowerCase()) : LadiPage.isDesktop() : e.runtime.isDesktop = t ? window.ladi_is_desktop : LadiPage.isDesktop(),
        ...
        try {
            ...
            e.runtime.tmp.cookie_ladi_data = d,
        ...
        p.forEach(function(t) {
            if (t != e.const.TRACKING_NAME && t != e.const.ACCESS_KEY_NAME) {
                if (e.setDataReplaceStr(t, u[t]),
                "products" == t && isStringLadiPage(u[t])) {
                    var i = u[t].split("|");
                    2 == i.length && -1 == p.indexOf("product_id") && e.setDataReplaceStr("product_value", i[0]),
                    2 == i.length && -1 == p.indexOf("product_name") && e.setDataReplaceStr("product_name", i[1])
                }
                (isArrayLadiPage(c[t]) ? c[t] : [c[t]]).forEach(function(e) {
                    isEmptyLadiPage(m) ? m += "?" : m += "&",
                    m += t + "=" + encodeURIComponent(e)
                })
            }
        }),
        ...
        var _ = Object.keys(e.runtime.eventData)
          ...
          , C = function(t, i, a) {
            if ("FormSubmit" == t && isEmptyLadiPage(f))
                ...
                e.runtime.is_popupx && (c.type = "POPUPX",
                ...
                isEmptyLadiPage(c.element_id)) ? e.runTimeout(function() {
                    C(t, i, a)
                }, 100) : ("FormSubmit" == t && (isEmptyLadiPage(L) ? P++ : (A == w && P++,
                S++),
                window.ladi("LADI_CAMP_FORM_SUBMIT").set_cookie(S, 3650),
                window.ladi("LADI_FORM_SUBMIT").set_cookie(P, 3650),
                e.runtime.is_popupx && e.runtime.tmp.runActionPopupX({
                    action: {
                        type: "set_submit_form"
                    }
                })),
                "PageView" == t && e.runtime.has_popupx && (v++,
                window.ladi("LADI_PAGE_VIEW").set_cookie(v, 3650)),
                "FormSubmit" != t && "PageView" != t || isEmptyLadiPage(e.runtime.tmp.cookie_ladi_data) || !e.runtime.is_popupx && isEmptyLadiPage(L) || (c.ladi_data = e.runtime.tmp.cookie_ladi_data),
                e.sendRequest("POST", e.const.API_ANALYTICS_EVENT, JSON.stringify(c), !0, {
          ...
          , N = function(t, i, a, n) {
            ...
            if (isEmptyLadiPage(i) || "POPUP_PRODUCT" != i.id)
                if (isEmptyLadiPage(i) || "POPUP_BLOG" != i.id)
                    ...
                    var l = function() {
                        ...
                        c) {
                                    ...
                                    e.showParentVisibility(r[0], function() {
                                        for (s = 0; s < r.length; s++) {
                                            if (r[s].querySelectorAll(".ladi-headline, .ladi-paragraph").length > 0 && r[s].hasAttribute("data-height")) {
                                                ...
                                                t != r[s].clientHeight && (r[s].setAttribute("data-height", r[s].clientHeight),
                                                a(r[s], t))
                                            }
                                        }
                                    }),
                            ...
                            var m = function(t) {
                                (!e.runtime.isDesktop || isEmptyLadiPage(t.getAttribute("height")) && isEmptyLadiPage(t.style.getPropertyValue("height"))) && (t.addEventListener("load", p),
                            ...
                            for (s = 0; s < r.length; s++)
                                for (var g = r[s].querySelectorAll(".ladi-headline img, .ladi-paragraph img"), _ = 0; _ < g.length; _++)
                                    m(g[_]);
                            isFunctionLadiPage(n) && n(),
                            p(),
                            e.runTimeout(function() {
                ...
                for (r = document.querySelectorAll("#" + i.id + " .ladi-element"),
                s = 0; s < r.length; s++)
                    e.runtime.tmp.runLadiSaleProductKey(r[s].id, !1, !1, d, o),
                    _(r[s]);
                isFunctionLadiPage(n) && n()
            }
        }
                ...
                if (i.action_type == e.const.ACTION_TYPE.complete) {
                    ...
                    if (i.type == e.const.DATA_ACTION_TYPE.section) {
                        ...
                        if (!isEmptyLadiPage(s)) {
                            ...
                            if (o = e.findAncestor(t, "ladi-popup"),
                            !isEmptyLadiPage(o)) {
                    ...
                    if (i.type == e.const.DATA_ACTION_TYPE.popup && (o = document.getElementById(i.action),
                    isEmptyLadiPage(o) || N(t, o, a, function() {
                    ...
                    i.type == e.const.DATA_ACTION_TYPE.change_index && (r = window.ladi(i.action),
                    isFunctionLadiPage(r[i.change_index_type]) ? r[i.change_index_type]() : r.index(i.change_index_number || 1)),
                    i.type == e.const.DATA_ACTION_TYPE.set_value && (r = window.ladi(i.action),
                    isEmptyLadiPage(r) || (i.is_clipboard ? e.getTextClipboard(i.str, function(e, a) {
                        r.value(e ? a : i.str),
                        I(t, e, !0)
                    }) : r.value(i.str))),
                    i.type == e.const.DATA_ACTION_TYPE.link) {
                        var c = i.action;
                        isEmptyLadiPage(c) || (c = e.getLinkUTMRedirect(c, null),
                        c = e.convertDataReplaceStr(c, !0),
                        window.ladi(c).open_url(i.target, i.nofollow))
                    }
                }
            })
        }
          ...
          , x = function(t, i, a, n, o) {
            if (t = t || document.getElementById(i),
            !isEmptyLadiPage(t)) {
                var r = function(t) {
                    if (!isEmptyLadiPage(t))
                ...
                if (!n["option.action_funnel"] || isEmptyLadiPage(h))
                    if (!c || isEmptyLadiPage(u)) {
                        ...
                        isObjectLadiPage(n["option.data_action"]))) {
                            ...
                            m.action_type = e.const.ACTION_TYPE.action,
                            p.push(m)
                        }
                        ...
                        p.forEach(function(a) {
                            if (a.action_type == e.const.ACTION_TYPE.action || a.action_type == e.const.ACTION_TYPE["1st_click"] || a.action_type == e.const.ACTION_TYPE["2nd_click"]) {
                                if (f++,
                                a.type == e.const.DATA_ACTION_TYPE.set_value_2nd && t.addEventListener("click", function(e) {
                                    if (d(t, e) && l(a)) {
                                ...
                                a.type == e.const.DATA_ACTION_TYPE.link) {
                                    ...
                                    t.addEventListener("click", function(i) {
                                        d(t, i) && l(a) && "true" == t.getAttribute("data-action") && (r = a.action,
                                        isEmptyLadiPage(a.action_mapping) || (r = a.action_mapping),
                                        isEmptyLadiPage(r) || (r = e.getLinkUTMRedirect(r, null),
                                        r = e.convertDataReplaceStr(r, !0),
                                        window.ladi(r).open_url(a.target, a.nofollow)))
                                    });
                                    var s = function() {
                                        if (isNullLadiPage(o) && (o = e.generateVariantProduct(n, !1, null, null, null, null, !0, !0, s)),
                                        isObjectLadiPage(o) && isObjectLadiPage(o.store_info) && isObjectLadiPage(o.product)) {
                                            ...
                                            isEmptyLadiPage(i) || (a.action_mapping = o.product[i],
                                            isEmptyLadiPage(a.action_mapping) || (r = a.action_mapping)),
                                            isEmptyLadiPage(r) ? (t.removeAttribute("data-replace-href"),
                                            t.removeAttribute("href")) : (r = e.getLinkUTMRedirect(r, null),
                                    ...
                                    if (d(t, i) && l(a)) {
                                        ...
                                        if (!isEmptyLadiPage(o)) {
                                            ...
                                            if (!isEmptyLadiPage(r)) {
                                                ...
                                                s.hasAttribute("data-popup-backdrop") && (window.ladi(s.id).hide(),
                                                n = 100)
                                            }
                                            e.runTimeout(function() {
                                ...
                                a.type == e.const.DATA_ACTION_TYPE.copy_clipboard && t.addEventListener("click", function(i) {
                                    if (d(t, i) && l(a)) {
                                        ...
                                        isEmptyLadiPage(n) || e.copyTextClipboard(n, _)
                                    }
                                });
                                var u = null;
                                if (a.type == e.const.DATA_ACTION_TYPE.lightbox ? u = a.lightbox_type : "lightbox_image" == a.type ? u = e.const.DATA_ACTION_LIGHTBOX_TYPE.image : "lightbox_video" == a.type ? u = e.const.DATA_ACTION_LIGHTBOX_TYPE.video : "lightbox_iframe" == a.type && (u = e.const.DATA_ACTION_LIGHTBOX_TYPE.iframe),
                                u == e.const.DATA_ACTION_LIGHTBOX_TYPE.image && t.addEventListener("click", function(i) {
                                    if (d(t, i) && l(a)) {
                                        var n = a.image_url;
                                        isEmptyLadiPage(n) && (n = a["image_url_" + e.runtime.device]),
                                        lightbox_image(n)
                                    }
                                }),
          ...
          , D = function(t, i, a, n) {
            ...
            !isEmptyLadiPage(t)) {
                if (!isArrayLadiPage(n)) {
                    var o = e.copy(n);
                    n = [],
                    isObjectLadiPage(o) && (o.action_type = e.const.ACTION_TYPE.hover,
                    n.push(o))
                }
          ...
          , F = function(t, i, a, n, o, r, d, s) {
            "countdown" != a || isEmptyLadiPage(n) || (i = i || document.getElementById(t),
            isEmptyLadiPage(i) || (i.setAttribute("data-type", n),
            ...
            n != e.const.COUNTDOWN_TYPE.daily || isEmptyLadiPage(r) || isEmptyLadiPage(d) || (i.setAttribute("data-daily-start", r),
            i.setAttribute("data-daily-end", d))))
        }
          , q = function(t, e, i, a) {
          ...
          , M = function() {
            for (var t = 1e3, i = 0; i < LadiPageTrackingCommandList.length; i++) {
                ...
                if (isFunctionLadiPage(a.callback1) && a.callback1()) {
                    ...
                    LadiPageTrackingCommandList.splice(i, 1),
                    t = 0;
                    break
                }
            }
          ...
          , Y = function() {
            if (t) {
                var i = function() {
                    if (e.runtime.ladipage_powered_by_classname = e.randomString(e.randomInt(6, 32)),
                    e.runtime.isClient) {
                        var t = document.createElement("div");
                        document.body.insertBefore(t, document.body.childNodes[e.randomInt(0, document.body.childNodes.length)]),
                ...
                C("PageView", {}, function(t, n) {
                    ...
                    200 == t) {
                        ...
                        s = o.data.places_autocomplete) : r = 1 == o.data,
                        a || r || e.runTimeout(i, 3e3),
                        isObjectLadiPage(d) && function(t, i, a) {
                            if (!isEmptyLadiPage(t)) {
                                var n = !1;
                        ...
                        isObjectLadiPage(s) && (l = s.api_key,
                        isEmptyLadiPage(l) || (window.onloadGooglePlacesAutocompleteCallback = function() {
                ...
                if (isEmptyLadiPage(e.runtime.timeout_gallery[o]) && (!e.runtime.tmp.gallery_playing_video || !i)) {
                    ...
                    if (0 != r.length && 0 != r.length) {
                        ...
                        e.runtime.timeout_gallery[o] = e.runTimeout(function() {
                            ...
                            e.runtime.timeout_gallery[o] = e.runTimeout(function() {
                                for (var t = 0; t < r.length; t++)
                                    t == l ? r[t].classList.add("selected") : r[t].classList.remove("selected"),
                        ...
                        for (var m = 0; m < d.length; m++)
                            (parseFloatLadiPage(d[m].getAttribute("data-index")) || 0) == l ? d[m].classList.add("selected") : d[m].classList.remove("selected");
          ...
          , j = function(t, i, a) {
            ...
            isEmptyLadiPage(s) ? (n == e.const.VIDEO_TYPE.youtube && (s = document.createElement("iframe"),
            i.parentElement.insertBefore(s, i.nextSibling),
            s.outerHTML = '<iframe id="' + d + '" class="iframe-video-preload" data-video-type="' + n + '" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0;" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
            e.runEventPlayVideo(d, n, o, !1, !1, !0, a, !1, !0)),
            n == e.const.VIDEO_TYPE.direct && (s = document.createElement("video"),
            i.parentElement.insertBefore(s, i.nextSibling),
            ...
            e.runEventPlayVideo(d, n, o, !1, !1, !0, a, !1, !0))) : e.runEventReplayVideo(d, n, !0)
        }
          , H = function(t, i, a, n) {
            if ("gallery" == n && (a || (i = document.getElementById(t)),
            !isEmptyLadiPage(i))) {
                ...
                if (o > 0) {
                    for (var s = 0; s < o; s++) {
                        ...
                        isEmptyLadiPage(l) || (d && j(i, l, d),
                        l.classList.contains("play-video") && l.addEventListener("click", r))
                    }
                    i.setAttribute("data-current", 0),
                    i.setAttribute("data-is-next", !0)
                }
                for (var c = i.getElementsByClassName("ladi-gallery-view-arrow"), u = 0; u < c.length; u++)
          ...
          , G = function(t, i) {
            ...
            var d = parseFloatLadiPage(t.target.getAttribute("data-index")) || 0
              , s = null
              , l = null;
            (parseFloatLadiPage(i.getAttribute("data-current")) || 0) > d ? (s = "prev",
            l = "right") : (s = "next",
            l = "left");
            var c = i.getAttribute("data-is-next") || "true";
            (c = "true" == c.toLowerCase()) ? d-- : d++,
            i.setAttribute("data-current", d),
                    ...
                    for (var a = document.querySelectorAll("#" + t), n = 0; n < a.length; n++) {
                        ...
                        if ("true" == o.getAttribute("data-scrolled") && "true" != o.getAttribute("data-stop")) {
                            var r = i[e.runtime.device + ".option.gallery_control.autoplay"]
                              ...
                              , s = 0;
                            if (r && !isEmptyLadiPage(d) && (s = d),
                            s > 0) {
                                var l = o.getAttribute("data-next-time")
                                  , c = Date.now();
                                isEmptyLadiPage(l) && (l = c + 1e3 * (s - 1),
                                o.setAttribute("data-next-time", l)),
                                c >= l && (V(o, !0),
                                o.setAttribute("data-next-time", c + 1e3 * s))
                            }
                        }
                    }
            })
            ...
            if ("gallery" == a.type) {
                ...
                var s = function(t) {
                  ...
                  , l = function(t) {
                    ...
                    !(t = e.getEventCursorData(t)).target.classList.contains("ladi-gallery-view-arrow")) {
                        var a = i.getAttribute("data-runtime-id");
                        isEmptyLadiPage(e.runtime.timeout_gallery[a]) && (e.runtime.current_element_mouse_down_gallery_view = a,
                        e.runtime.current_element_mouse_down_gallery_view_position_x = t.pageX)
                    }
                }
                  , c = function(t) {
                    t.stopPropagation(),
                    t = e.getEventCursorData(t),
                    (i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-top") || i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-bottom")) && (t.target.classList.contains("ladi-gallery-control-arrow") || (e.runtime.current_element_mouse_down_gallery_control = n,
                ...
                i.getElementsByClassName("ladi-gallery-control-arrow-left")[0].addEventListener("click", function(t) {
                    ...
                    if (!isEmptyLadiPage(e)) {
                        ...
                        if (i.getElementsByClassName("ladi-gallery-control-arrow-left")[0].classList.remove("opacity-0"),
                        i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.remove("opacity-0"),
                        i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-top") || i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-bottom")) {
                ...
                (parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control-box")[0]).width) || 0) > (parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control")[0]).width) || 0) && i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].classList.remove("opacity-0"),
                ...
                for (var u = i.getElementsByClassName("ladi-gallery-control-item"), p = 0; p < u.length; p++)
          ...
          , X = function(t, i) {
            if ((isEmptyLadiPage(e.runtime.timenext_carousel[t]) || !(e.runtime.timenext_carousel[t] > Date.now())) && isEmptyLadiPage(e.runtime.current_element_mouse_down_carousel)) {
                ...
                if (!isEmptyLadiPage(a)) {
                    ...
                    isEmptyLadiPage(m) || m.classList.remove("opacity-0"),
                    isEmptyLadiPage(g) || g.classList.remove("opacity-0"),
          ...
          , z = function() {
            var i, a = document.getElementsByClassName("ladi-form"), n = 0, o = null, r = null, d = null, c = null, u = null, p = null, m = null, _ = null, y = null, f = null, v = null, P = null, L = null, E = null, b = null, w = null, T = null, S = null, N = e.runtime.shopping, I = null, x = ["utm_source", "utm_medium", "utm_campaign", "utm_term", "utm_content"], D = ["name", "email", "phone", "address", "ward", "district", "state", "country"], R = ["email", "phone"], F = e.copy(e.runtime.list_set_value_name_country).reverse(), q = function(t, i) {
                ...
                if (isEmptyLadiPage(n) && isObjectLadiPage(r) && !isEmptyLadiPage(r[a]) && (n = r[a],
                o = !0),
                isEmptyLadiPage(n)) {
                    ...
                    o ? (r[a] = n,
                    e.runtime.tmp["cookie_cache_otp_" + t] = r) : window.ladi(a).set_cookie(n, d)
                }
                return n
            }, B = function(t, i, a) {
                ...
                i && (o = o.only([a])),
                o.length > 0)
                    return i || e.showMessage(e.const.LANG.FORM_INPUT_REQUIRED_ERROR, null, function() {
                ...
                if (!d)
                    return i || e.showMessage(e.const.LANG.FORM_INPUT_REQUIRED_ERROR),
                    !1;
                var g = !0
                  , _ = 0
                  , y = function() {
                        ...
                        if (!isEmptyLadiPage(v))
                            try {
                                if (!new RegExp("^" + S[_].pattern + "$",S[_].pattern_flag).test(v)) {
                                    i || e.showMessage(S[_].title, null, y),
                                    g = !1;
                                    break
                                }
                            } catch (t) {}
                ...
                for (var a = t.querySelectorAll(".ladi-element .ladi-form-item-container [name]"), n = {}, o = null, l = 0; l < a.length; l++)
                    o = a[l].getAttribute("name"),
                    n[o] = parseInt(a[l].getAttribute("tabindex")) || 0;
                ...
                for (var f = 0; f < a.length; f++) {
                    o = a[f].getAttribute("name"),
                    a[f].required && -1 == T.indexOf(o) && T.push(o);
                    var v = null;
                    if ("INPUT" == a[f].tagName) {
                        ...
                        }) : isEmptyLadiPage(P) || S.push({
                            name: o,
                            pattern: P,
                            title: isEmptyLadiPage(h) ? e.const.LANG.FORM_INPUT_TEXT_REGEX : h
                        }),
                        "checkbox" == v) {
                            isArrayLadiPage(r[o]) || (r[o] = []),
                            a[f].checked && r[o].push(a[f].value);
                            continue
                        }
                        if ("radio" == v) {
                    ...
                    if (r[o] = a[f].value,
                    a[f].classList.contains("ladi-form-control-file") && (r[o] = JSON.parse(a[f].getAttribute("data-path-file") || "[]"),
                    c[o] = !0),
                    ...
                    "INPUT" == a[f].tagName && "date" == v && !isEmptyLadiPage(r[o])) {
                        var L = a[f].getAttribute("date-format") || "dd-mm-yyyy"
                          , E = new Date(r[o]);
                        L = (L = (L = (L = L.replaceAll("dd", (E.getDate() < 10 ? "0" : "") + E.getDate())).replaceAll("mm", (E.getMonth() + 1 < 10 ? "0" : "") + (E.getMonth() + 1))).replaceAll("yyyy", E.getFullYear())).replaceAll("yy", E.getFullYear() - 2e3),
                        r[o] = L
                    }
                }
                i || D.forEach(function(t) {
                    isNullLadiPage(r[t]) || (window.ladi("_ladipage_" + t).set_cookie(r[t], 365, "/", window.location.host),
                    isArrayLadiPage(e.runtime.DOMAIN_SET_COOKIE) && e.runtime.DOMAIN_SET_COOKIE.forEach(function(e) {
                ...
                if (a)
                    l.status_send = e.const.STATUS_SEND.capture;
                else if (l.status_send = e.const.STATUS_SEND.sendform,
                N) {
                ...
                if (!isEmptyLadiPage(v)) {
                    ...
                    isEmptyLadiPage(p) || (isObjectLadiPage(l.options) || (l.options = {}),
                ...
                isEmptyLadiPage(P) || ["option.sync_ladisales_form_account_id", "option.sync_ladiflow_form_account_id", "option.sync_ladishare_form_account_id", "option.sync_ladichat_form_account_id"].forEach(function(t) {
                    isEmptyLadiPage(P[t]) || (isObjectLadiPage(l.options) || (l.options = {}),
                    isArrayLadiPage(l.options.external_form_config_ids) || (l.options.external_form_config_ids = []),
                    l.options.external_form_config_ids.push(P[t]))
                }),
                i.isFormOtp && !isEmptyLadiPage(y) && (isObjectLadiPage(l.options) || (l.options = {}),
                isObjectLadiPage(l.options.external_otp_config) || (l.options.external_otp_config = {}),
                l.options.external_otp_config.otp_config_id = y),
                isObjectLadiPage(l.options) && (l.options = JSON.stringify(l.options)),
                isEmptyLadiPage(L) || (l.total_revenue = L),
                ...
                if (m.forEach(function(t) {
                    ...
                    var i = {
                        name: t,
                        value: e = -1 != h.indexOf(t) ? LadiFormApi[t] : e
                    };
                    c[t] && (i.is_file = !0),
                    l.form_data.push(i)
                }),
                ...
                N) {
                    if (!isNullLadiPage(E)) {
                        ...
                        isEmptyLadiPage(e.runtime.tmp.add_to_cart_shipping_method_id) || l.form_data.push({
                            name: "cart_shipping",
                    ...
                    isEmptyLadiPage(e.runtime.tmp.current_use_coupon) || l.form_data.push({
                ...
                e.runtime.has_popupx && l.tracking_form.push({
                ...
                isEmptyLadiPage(g) || l.tracking_form.push({
                    name: e.const.REF_NAME,
                    value: g
                }),
                e.runtime.tmp["form_data_ladi_tmp_" + f] = e.copy(l);
                var S = e.runtime.tmp["form_data_ladi_" + f];
                isObjectLadiPage(S) && (l = e.copy(S)),
                isEmptyLadiPage(b) || (l.captcha_token = b,
                l.captcha_type = w);
                i.isFormOtp && (i.isSetOtpId && function() {
                    ...
                    isEmptyLadiPage(a) && isObjectLadiPage(o) && !isEmptyLadiPage(o[t]) && (a = o[t],
                    n = !0);
                    var r = new Date
                      , d = [];
                    isEmptyLadiPage(a) ? d = [e.randomId(), r.getTime(), 1] : ((d = a.split("|"))[1] = parseInt(d[1]) || Date.now(),
                    d[2] = parseInt(d[2]) || 1,
                    i.isSendOtp || (d[2] += 1),
                    d.splice(3)),
                    ...
                    a = d.join("|"),
                    n ? (o[t] = a,
                    e.runtime.tmp["cookie_cache_otp_" + f] = o) : window.ladi(t).set_cookie(a, r),
                    d.splice(1),
                    a = d.join("|"),
                    l.otp_id = a
                }(),
                ...
                i.isSendOtp && (l.otp_code = i.otp_code,
                ...
                if (!isEmptyLadiPage(o)) {
                    for (var r = document.querySelectorAll('.ladi-form [data-submit-form-id="' + o.id + '"]'), d = 0; d < r.length; d++) {
                        ...
                        if (!isEmptyLadiPage(s) && (s = e.findAncestor(s, "ladi-element"),
                        !isEmptyLadiPage(s))) {
                            var l = s.querySelector(".ladi-form-remove-coupon");
                            if (isEmptyLadiPage(l)) {
                                var c = s.querySelector('input[name="coupon"]');
                                isEmptyLadiPage(c) || (c.value = "",
                                e.fireEvent(c, "change"))
                            } else
                                l.click()
                        }
                    }
                    var u = document.getElementById(o.getAttribute("data-form-id-before"));
                    isEmptyLadiPage(u) || (u = u.getElementsByClassName("ladi-form")[0],
                    V(u))
                }
                for (var p = document.querySelectorAll('[data-combobox-type="delivery_method"]'), m = 0; m < p.length; m++)
                    p[m].hasAttribute("data-placeholder") && (p[m].innerHTML = '<option value="">' + p[m].getAttribute("data-placeholder") + "</option>"),
                ...
                M(a, !1),
                B(a, !1, null) && (Y(0, i, !1, n, function(t) {
                ...
                B(t, a, n)) {
                    for (var d = t.querySelectorAll(".ladi-element .ladi-form-item-container [name]"), s = {}, l = null, c = 0; c < d.length; c++)
                        l = e.findAncestor(d[c], "ladi-element"),
                        s[d[c].getAttribute("name")] = l.id;
                    ...
                    if ((g.mapping_form_id || []).forEach(function(i) {
                        ...
                        if (!isEmptyLadiPage(r)) {
                            ...
                            if (!a || !isEmptyLadiPage(u) && u["option.form_auto_capture"]) {
                                isFunctionLadiPage(o.getOtp) && !isEmptyLadiPage(u) && u["option.is_form_otp"] && (isFunctionLadiPage(o.beforeRunOtp) && o.beforeRunOtp(r),
                                e.runtime.func_get_code_otp[r.id] = o.getOtp);
                                var p = [];
                                if (_.forEach(function(t) {
                                    ...
                                    for (a = a.unique(),
                                    c = 0; c < a.length; c++)
                                        window.ladi(a[c]).value(i)
                                }),
                                a)
                                    for (c = 0; c < p.length; c++)
                                        e.fireEvent(p[c], "focusout")
                            }
                        }
                    }),
                    !a) {
                        ...
                        if (!isArrayLadiPage(y)) {
                            var f = e.copy(g);
                            if (y = [],
                            isObjectLadiPage(f) && (f.type = f.event_type,
                            ...
                            !isEmptyLadiPage(f.value))) {
                                if (f.type != e.const.DATA_ACTION_TYPE.section && f.type != e.const.DATA_ACTION_TYPE.popup || y.push({
                                ...
                                f.type == e.const.DATA_ACTION_TYPE.change_index && y.push({
                                    action_type: e.const.ACTION_TYPE.complete,
                                    type: f.type,
                                    action: f.value,
                    ...
                    o.isRunTracking && e.runEventTracking(t.id, {
                        is_form: !0
                    }, r)
                }
            }, U = function(i, a, s, l, g, A) {
                if (I = e.getURLSearchParams(null, null, !1),
                n = 0,
                o = null,
                r = {},
                d = {},
                ...
                E = null,
                b = a.captcha_token,
                isObjectLadiPage(e.runtime.tmp.google_captcha) && (w = e.runtime.tmp.google_captcha.type,
                !s && isEmptyLadiPage(b) && a.hasOwnProperty("captcha_token")))
                    H();
                else {
                    T = [],
                    S = [],
                    N = e.findAncestor(i, "ladi-popup"),
                    isEmptyLadiPage(N) ? N = !1 : (N = e.findAncestor(N, "ladi-element"),
                    N = !isEmptyLadiPage(N) && "POPUP_CHECKOUT" == N.id);
                    var O = i.getElementsByClassName("ladi-form")[0];
                    if (!isEmptyLadiPage(O)) {
                        var k = e.runtime.eventData[i.id];
                        if (!isEmptyLadiPage(k)) {
                            if (k["option.is_add_to_cart"])
                                return;
                            _ = k["option.form_config_id"],
                            y = isObjectLadiPage(k["option.form_setting"]) ? k["option.form_setting"].otp_config_id : null,
                            f = i.id,
                            v = i,
                            P = k,
                            L = parseFloatLadiPage(k["option.form_purchase_value"]) || 0,
                            N && (L = e.getCartCheckoutPrice(L),
                            E = e.getCartProducts())
                        }
                        var D = null
                          , R = null
                        ...
                        if (s) {
                            ...
                            if (a.captcha && !isEmptyLadiPage(k) && k["option.form_captcha"] && isObjectLadiPage(e.runtime.tmp.google_captcha)) {
                                if (window.grecaptcha)
                                    if (e.runtime.tmp.google_captcha.enterprise && window.grecaptcha.enterprise)
                                        ...
                                        try {
                                            D = i.getElementsByClassName("ladi-google-recaptcha-checkbox")[0],
                                            R = i.getAttribute("data-button-submit-other"),
                                            isEmptyLadiPage(R) || (D = document.querySelector("#" + R + " .ladi-google-recaptcha-checkbox")),
                                            F = D.getAttribute("data-widget-id"),
                                            q = window.grecaptcha.getResponse(F),
                                            U(i, {
                                                captcha_token: q
                                            }, s, l, g, A)
                                        } catch (t) {}
                            ...
                            Y(0, A, s, l, function(t) {
                                ...
                                !isEmptyLadiPage(e.runtime.tmp.capture_form_data_last[l + "_" + g]) && equalsLadiPage(e.runtime.tmp.capture_form_data_last[l + "_" + g], a) || (e.runtime.tmp.capture_form_data_last[l + "_" + g] = a,
                                e.sendRequest("POST", e.const.API_FORM_DATA, JSON.stringify(t), !0, {
                                    "Content-Type": "application/json"
                                }))
                            })
                        } else if (isEmptyLadiPage(k))
                            j(0, A, O, l);
                        else if (isNullLadiPage(e.runtime.tmp.form_sending) && (e.runtime.tmp.form_sending = {}),
                        ...
                        !e.runtime.tmp.form_sending[i.id]) {
                            var G = function() {
                                ...
                                isNullLadiPage(e.runtime.tmp.form_button_headline[i.id]) && (e.runtime.tmp.form_button_headline[i.id] = t.innerHTML),
                                A.isFormOtp || (t.innerHTML = "● ● ●")
                            }
                              , W = function() {
                                delete e.runtime.tmp.form_sending[i.id],
                                O.querySelector(".ladi-button .ladi-headline").innerHTML = e.runtime.tmp.form_button_headline[i.id]
                            };
                            if (a.captcha && !isEmptyLadiPage(k) && k["option.form_captcha"] && isObjectLadiPage(e.runtime.tmp.google_captcha))
                                if (window.grecaptcha)
                                    if (G(),
                                ...
                                var X = k["option.form_send_ladipage"]
                                  ...
                                  , tt = function() {
                                    isObjectLadiPage(A) && isFunctionLadiPage(A.callbackOtpShowThankYouDone) && A.callbackOtpShowThankYouDone(),
                                    isFunctionLadiPage(o) && o();
                                    var a = !1;
                                    if (e.runtime.has_popupx && e.runtime.tmp.popupx_is_inline)
                                        a = !0;
                                    else if (K != e.const.FORM_THANKYOU_TYPE.url) {
                                        var n = e.findAncestor(i, "ladi-popup");
                                        isEmptyLadiPage(n) || (n = e.findAncestor(n, "ladi-element"),
                                        e.runRemovePopup(n.id, t))
                                    }
                                    var r = 0;
                                    ...
                                    if (!Q || isEmptyLadiPage(h)) {
                                        if (K == e.const.FORM_THANKYOU_TYPE.default && (isEmptyLadiPage(J) || e.showMessage(J, p)),
                                        K == e.const.FORM_THANKYOU_TYPE.popup && (Z && e.setDataReplaceElement(!1, !1, p, J),
                                        window.ladi(J).show(!1, {
                                            formThankyouPopupXInline: a
                                        })),
                                        K == e.const.FORM_THANKYOU_TYPE.url && !isEmptyLadiPage(J)) {
                                ...
                                if (k["option.only_facebook_widget"]) {
                                    if (isObjectLadiPage(window.LadiFlow) && isFunctionLadiPage(window.LadiFlow.confirmCheckbox))
                                        for (var et = i.getElementsByClassName("ladiflow-widget"), it = 0; it < et.length; it++)
                                            window.LadiFlow.confirmCheckbox(et[it].id);
                                    return e.runEventTracking(i.id, {
                                        is_form: !0
                                    }, r),
                                    void tt()
                                }
                                if (isEmptyLadiPage(_) && isEmptyLadiPage(k["option.sync_ladisales_form_account_id"]) && isEmptyLadiPage(k["option.sync_ladiflow_form_account_id"]) && isEmptyLadiPage(k["option.sync_ladishare_form_account_id"]) && isEmptyLadiPage(k["option.sync_ladichat_form_account_id"]))
                                    j(0, A, O, l);
                                else if (M(O, s),
                                B(O, s, g)) {
                                    var at = 0
                                      ...
                                      , ut = function(t) {
                                        ...
                                        -1 != [e.const.FORM_CONFIG_TYPE.ladisales].indexOf(e.runtime.shopping_product_type) && (window.ladi("_cart_token").delete_cookie(),
                                      ...
                                      , pt = function(t, a, n, o) {
                                        if (n.readyState == XMLHttpRequest.DONE) {
                                            ...
                                            o == e.const.API_FORM_DATA ? 200 == s.code ? at++ : (1 != s.code || isEmptyLadiPage(s.message) || (ot = s.message),
                                            nt++,
                                            lt = !1) : 200 == a || 201 == a ? at++ : e.getElementAHref(o).host == e.const.DOMAIN_GOOGLE_DOCS ? at++ : nt++,
                                            at + nt == rt.length && (lt && !dt && at >= 1 ? (dt = !0,
                                            isFunctionLadiPage(A.callbackOtp) && A.callbackOtp(!0),
                                            isObjectLadiPage(A) && isFunctionLadiPage(A.callbackThankyou) ? (W(),
                                            ...
                                            Object.keys(e.runtime.replaceStr).forEach(function(t) {
                                                d.hasOwnProperty(t) || (d[t] = e.runtime.replaceStr[t]),
                                                p.hasOwnProperty(t) || (p[t] = e.runtime.replaceStr[t])
                                            }),
                                            function(t, i, a) {
                                                var n = null
                                                  , o = !1
                                                  , r = function(t, i) {
                                                    o || (isFunctionLadiPage(a) && a(t, i),
                                                    e.removeTimeout(n),
                                                    o = !0)
                                                };
                                            ...
                                            }))) : !st && nt >= 1 && (isFunctionLadiPage(A.callbackOtp) && A.callbackOtp(!1),
                                            st = !0,
                                            e.showMessage(ot || e.const.LANG.REQUEST_SEND_ERROR),
                                            ct(!1)))
                                        }
                                    }
                                      , mt = function(t) {
                                    ...
                                    X && Y(0, A, s, l, mt),
                                    isArrayLadiPage(z) && z.forEach(function(t) {
                                        if (!isEmptyLadiPage(t.api_url) && isArrayLadiPage(t.custom_fields)) {
                                            ...
                                            t.custom_fields.forEach(function(t) {
                                                if (N && ("cart_products" == t.ladi_name && (n = t.name),
                                            ...
                                            isEmptyLadiPage(n) || isNullLadiPage(E) || (a[n] = JSON.stringify(E)),
                                            isEmptyLadiPage(o) || isNullLadiPage(L) || (a[o] = L),
                                            isEmptyLadiPage(r) || isNullLadiPage(e.runtime.tmp.add_to_cart_shipping_method_id) || (a[r] = e.runtime.tmp.add_to_cart_shipping_method_id + "|" + (e.runtime.tmp.add_to_cart_fee_shipping || 0)),
                                            ...
                                            if (m == e.const.CONTENT_TYPE.form_urlencoded && (s["Content-Type"] = "application/x-www-form-urlencoded",
                                            p = Object.keys(a).reduce(function(t, e) {
                                                return t.push(e + "=" + encodeURIComponent(a[e])),
                                                t
                                            }, []).join("&")),
                                            m == e.const.CONTENT_TYPE.json && (s["Content-Type"] = "application/json",
                                            p = JSON.stringify(a)),
                                    ...
                                    (rt.length > 0 || !X) && G(),
                                    e.runTimeout(function() {
                                        0 == rt.length && (X ? j(0, A, O, l) : Y(0, A, s, l, mt)),
                ...
                if (!isEmptyLadiPage(i))
                    for (var a = i.querySelectorAll('[type="checkbox"]'), n = 0; n < a.length; n++)
                ...
                if (!isEmptyLadiPage(i)) {
                    ...
                    if (-1 == o) {
                        var s = function(t) {
                            var e = !1
                              , n = null;
                            isEmptyLadiPage(a["option.form_config_id"]) || ((a["option.form_auto_capture"] || t.isFormOtp) && (n = q(i.id, a["option.form_config_id"])),
                            a["option.form_auto_capture"] && (e = !0));
                            var o = {
                                captcha: !0
                            };
                            (t.isResendOtp || t.isSendOtp) && (o.captcha = !1),
                            t.isFormOtp && (t.isCapture = e),
                            U(i, o, !1, n, null, t)
                        }
                          , l = function(t) {
                            window.ladi("_capture_" + i.id).delete_cookie(),
                            ...
                            n.forEach(function(i) {
                                ...
                                t && delete e.runtime.tmp["cookie_cache_otp_" + i]
                            }),
                            t && (delete e.runtime.tmp["cookie_cache_otp_" + i.id],
                            delete e.runtime.tmp["form_data_ladi_" + i.id],
                            delete e.runtime.tmp["form_data_ladi_tmp_" + i.id])
                        }
                          , c = function(t) {
                            var i = t.getElementsByClassName("ladi-form")[0]
                              ...
                              , o = function() {
                                isEmptyLadiPage(a) || window.ladi(a.id).hide(),
                                i.reset()
                            };
                            i.onsubmit = function() {
                        ...
                        if (!isEmptyLadiPage(a) && a["option.is_form_login"])
                                        ...
                                        if (a.readyState == XMLHttpRequest.DONE) {
                                            ...
                                            try {
                                                if (200 == (d = JSON.parse(t)).code) {
                                                    ...
                                                    return (u.startsWith("?") || u.startsWith("&")) && (u = u.substring(1)),
                            ...
                            a["option.form_setting"].is_multiple_otp ? (l(!0),
                            _(!1, function(t) {
                                if (t) {
                                    var e = [];
                            ...
                            if (e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.ladisales && !isNullLadiPage(e.runtime.shopping_config_checkout_id)) {
                                ...
                                if (!isEmptyLadiPage(f) && (f = e.findAncestor(f, "ladi-element"),
                                !isEmptyLadiPage(f) && "POPUP_CHECKOUT" == f.id))
                                    return function(t) {
                                        ...
                                        var n = r.email
                                          , o = r.phone;
                                        if (isEmptyLadiPage(i) || isEmptyLadiPage(a))
                                            e.showMessage(e.const.LANG.FORM_INPUT_REQUIRED_ERROR);
                                        else if (isEmptyLadiPage(n) && isEmptyLadiPage(o))
                                            e.showMessage(e.const.LANG.FORM_INPUT_REQUIRED_ERROR);
                                        else {
                                            var d = r.name
                                              , s = r.address
                                            ...
                                            I = e.getURLSearchParams(null, null, !1),
                                            x.forEach(function(t) {
                                            ...
                                            e.sendRequest("POST", e.const.API_LADISALE_CHECKOUT_CREATE, JSON.stringify(L), !0, {
                                                "Content-Type": "application/json"
                                            }, function(t, i, a) {
                                                if (a.readyState == XMLHttpRequest.DONE) {
                                                    if (200 == i)
                                                        try {
                                                            var n = JSON.parse(t);
                                                            if (200 == n.code && isObjectLadiPage(n.data) && !isEmptyLadiPage(n.data.url))
                                                                return void window.ladi(window.ladi(n.data.url).get_url()).open_url();
                                                            if (!isEmptyLadiPage(n.message))
                                                                return void e.showMessage(n.message)
                                                        } catch (t) {}
                        ...
                        if (v.length > 0) {
                            ...
                            for (var P = 0; P < v.length; P++)
                                v[P].removeEventListener("change", W),
                                v[P].addEventListener("change", W);
                ...
                if (!isEmptyLadiPage(o)) {
                    ...
                    if (!(isEmptyLadiPage(r) || (a = i ? a : e.runtime.eventData[r.id],
                    isEmptyLadiPage(a) || !a["option.is_buy_now"] && !a["option.is_add_to_cart"] || isEmptyLadiPage(a["option.product_type"]) || isEmptyLadiPage(a["option.product_id"])))) {
                        var d = function() {
                            ...
                            if (isEmptyLadiPage(o) || isEmptyLadiPage(o.store_info) || isEmptyLadiPage(o.product))
                                isEmptyLadiPage(e.runtime.tmp.timeout_product_info[a["option.product_type"]][a["option.product_id"]]) && e.showMessage(e.const.LANG.ADD_TO_CART_NO_PRODUCT, {
                                ...
                                if (i) {
                                    ...
                                    isEmptyLadiPage(l) || (s = o.product.variants.findIndex(function(t) {
                                        return t.product_variant_id == l
                                    }))
                                } else
                                    s = e.getProductVariantIndex(r.id, a);
                                if (-1 != s) {
                                    ...
                                    if (0 == o.product.select_many_service && isArrayLadiPage(e.runtime.tmp.cart) && -1 != e.runtime.tmp.cart.findIndex(function(t) {
                                        ...
                                        e.showMessage(e.const.LANG.ADD_TO_CART_PRODUCT_ONLY_ONE, {
                                            name: e.getMessageNameProduct(o.product.variants[s])
                                        });
                                    else {
                                        ...
                                        if (isEmptyLadiPage(L) || isEmptyLadiPage(L.value))
                                            e.showMessage(e.const.LANG.ADD_TO_CART_QUANTITY_REQUIRED);
                                        else {
                                            var E = parseInt(L.value) || 0;
                                            if (E <= 0)
                                                return void e.showMessage(e.const.LANG.ADD_TO_CART_QUANTITY_REQUIRED);
                                            var b = null
                                              , A = 1;
                                            ...
                                            var T = !1;
                                            if (!isEmptyLadiPage(w) && e.runtime.tmp.cart[v].quantity + E > w && (E = w - e.runtime.tmp.cart[v].quantity) <= 0 && (T = !0,
                                            b = w),
                                            1 == o.product.variants[s].inventory_checked) {
                                                if (A > _)
                                                    return void e.showMessage(e.const.LANG.ADD_TO_CART_NO_QUANTITY, {
                                                        name: e.getMessageNameProduct(o.product.variants[s], !0)
                                                    });
                                                e.runtime.tmp.cart[v].quantity + E > _ && (E = _ - e.runtime.tmp.cart[v].quantity,
                                                _ > 0 && (T = !0,
                                                (isEmptyLadiPage(b) || b > _) && (b = _)))
                                            }
                                            if (T || E <= 0 && _ > 0)
                                                e.showMessage(e.const.LANG.ADD_TO_CART_MAX_QUANTITY, {
                                                    max: b,
                                                    name: e.getMessageNameProduct(o.product.variants[s])
                                                }, function() {
                                                    var i = t.target;
                                                    i = e.findAncestor(i, "ladi-button"),
                                                    isEmptyLadiPage(i) || (i = e.findAncestor(i, "ladi-element"));
                                                    var a = e.runtime.eventData[i.id];
                                                    if (!isEmptyLadiPage(a)) {
                                                        ...
                                                        n.forEach(function(t) {
                                                            t.action_type == e.const.ACTION_TYPE.action && (t.type == e.const.DATA_ACTION_TYPE.popup_cart && window.ladi("POPUP_CART").show(),
                                                ...
                                                if (S)
                                                    e.showMessage(e.const.LANG.ADD_TO_CART_PRODUCT_BEFORE_START_DATE, {
                                                        name: e.getMessageNameProduct(o.product.variants[s])
                                                    });
                                                else if (O)
                                                    e.showMessage(e.const.LANG.ADD_TO_CART_PRODUCT_AFTER_END_DATE, {
                                                        name: e.getMessageNameProduct(o.product.variants[s])
                                                    });
                                                else {
                                                    var C = function() {
                                                        ...
                                                        e.addCartCookie(o.store_info.id, t, function() {
                                                            isFunctionLadiPage(n) && n();
                                                            ...
                                                            e.runtime.tmp.cart[v].quantity -= E,
                                                            P && e.runtime.tmp.cart.splice(v, 1),
                                                            e.showMessage(t.message)
                                                        }, function() {
                                                            e.runtime.tmp.generateCart(),
                                                            e.changeTotalPriceCart(),
                                                            e.runtime.tmp.is_click_add_to_cart = !1,
                                                            0 == e.runtime.tmp.cart.length && -1 != [e.const.FORM_CONFIG_TYPE.ladisales].indexOf(e.runtime.shopping_product_type) && (window.ladi("_cart_token").delete_cookie(),
                                                            window.ladi("_checkout_token").delete_cookie()),
                                                            e.runResizeAll()
                                                        })
                                                    };
                                                ...
                                                _ <= 0 && e.showMessage(e.const.LANG.ADD_TO_CART_NO_QUANTITY, {
                                                    name: e.getMessageNameProduct(o.product.variants[s], !0)
                                                })
                                        }
                                    }
                ...
                isEmptyLadiPage(i) || (i = e.findAncestor(i, "ladi-element"),
                isEmptyLadiPage(i) || window.ladi(i.id).submit())
            }, $ = function(t) {
                var i = e.findAncestor(t.target, "ladi-form");
                if (!isEmptyLadiPage(i)) {
                        ...
                        if (!isEmptyLadiPage(n)) {
                            ...
                            if (isObjectLadiPage(n["option.form_setting"]) && n["option.form_setting"].is_multiple) {
                                if (!n["option.form_setting"].is_multiple_otp)
                                    return void G(a, n, !0, t.target.getAttribute("name"), {
                                        isRunTracking: !0
                                    });
                                o.isFormOtp = !0,
                                o.isCapture = !0
              ...
              , et = function(t) {
                for (var n = a[Q].querySelectorAll('.ladi-element .ladi-form-item-container [name="' + t + '"]'), o = null, r = 0; r < n.length; r++) {
                    ...
                    if (!isEmptyLadiPage(d) && "none" != getComputedStyle(n[r]).display)
                        if ("true" != n[r].getAttribute("data-is-select-country") && (d = i[t]),
                        "SELECT" == n[r].tagName)
                            n[r].querySelectorAll('option[value="' + d + '"]').length > 0 && (n[r].value = d,
                            tt && e.fireEvent(n[r], "change"));
                        else {
                            if ("country" == t && "true" == n[r].getAttribute("data-is-select-country"))
                                continue;
                            "INPUT" == n[r].tagName && "true" == n[r].getAttribute("data-is-select-country") && 2 == (o = d.split(":")).length && (d = o[1]),
                            n[r].value = d,
                            tt && e.fireEvent(n[r], "change")
                        }
                }
            ...
            for (Q = 0; Q < a.length; Q++) {
                ...
                for (var nt = e.findAncestor(a[Q], "ladi-element"), ot = a[Q].getElementsByClassName("ladi-button"), rt = 0; rt < ot.length; rt++) {
                    ...
                    if (!isEmptyLadiPage(dt)) {
                        ...
                        isEmptyLadiPage(nt) || isEmptyLadiPage(e.runtime.eventData[nt.id]) || !e.runtime.eventData[nt.id]["option.is_add_to_cart"] ? st.addEventListener("click", J) : (st.setAttribute("data-click", !1),
                        st.addEventListener("click", K))
                    }
                }
                ...
                for (var ut = a[Q].querySelectorAll('input[data-type="date"]'), pt = 0; pt < ut.length; pt++)
                    isEmptyLadiPage(ut[pt].getAttribute("placeholder")) || (e.runtime.isDesktop || e.runtime.isBrowserDesktop ? (ut[pt].setAttribute("type", "text"),
                    ut[pt].addEventListener("focus", it),
                    ut[pt].addEventListener("blur", at)) : ut[pt].value = (new Date).toISOString().substr(0, 10));
                var mt = a[Q].querySelectorAll("[tabindex]")
                  , gt = 0
                  , _t = 0;
                for (pt = 0; pt < mt.length; pt++)
                    (_t = parseInt(mt[pt].getAttribute("tabindex")) || 0) > gt && (gt = _t),
                    mt[pt].setAttribute("tabindex", e.runtime.tabindexForm + _t);
                for (mt = a[Q].querySelectorAll("[data-tabindex]"),
                pt = 0; pt < mt.length; pt++)
                    (_t = parseInt(mt[pt].getAttribute("data-tabindex")) || 0) > gt && (gt = _t),
                    mt[pt].setAttribute("data-tabindex", e.runtime.tabindexForm + _t);
            ...
            e.runtime.tmp.listAfterLocation.push(function() {
                var t = ""
                  ...
                  , l = function(t) {
                    ...
                    if (n = "",
                    !isEmptyLadiPage(i) && isObjectLadiPage(i.data)) {
                    ...
                    if (!isEmptyLadiPage(o)) {
                        ...
                        isEmptyLadiPage(l) || "SELECT" == l.tagName && (l.setAttribute("data-selected", ""),
                        l.innerHTML = l.querySelector("option").outerHTML),
                        e.reloadFeeShipping({
                            target: l
                        })
                    }
                  ...
                  , c = function(t) {
                    ...
                    if (!isEmptyLadiPage(i)) {
                        ...
                        if (!isEmptyLadiPage(a)) {
                            ...
                            "SELECT" == a.tagName && (a.setAttribute("data-selected", ""),
                  ...
                  , u = function(t) {
                    ...
                    if (!isEmptyLadiPage(i)) {
                        var a = i.querySelector('[name="ward"]');
                        isEmptyLadiPage(a) || "SELECT" != a.tagName || e.reloadFeeShipping({
                            target: a
                        })
                    }
                };
                for (Q = 0; Q < a.length; Q++) {
                    ...
                    for (m = 0; m < p.length; m++)
                        if (g = e.findAncestor(p[m], "ladi-element"),
                        !isEmptyLadiPage(g) && (i = e.runtime.eventData[g.id]["option.input_country"],
                        !isEmptyLadiPage(i) && (t = "",
                        i = i.split(":")[0],
                        !isEmptyLadiPage(window.LadiLocation[i])))) {
                            var _ = window.LadiLocation[i].data
                              , y = Object.keys(_);
                            r = _,
                            y.sort(d),
                            isArrayLadiPage(e.runtime.country_state_sort[i]) && (y = y.except(e.runtime.country_state_sort[i]),
                            y = e.runtime.country_state_sort[i].concat(y)),
                            y.forEach(s),
                ...
                n.addEventListener("change", function(t) {
                    !function(t, i, a) {
                        if (i.length > e.const.FORM_UPLOAD_FILE_LENGTH)
                            e.showMessage(e.const.LANG.FORM_UPLOAD_FILE_MAX_LENGTH_ERROR, {
                            ...
                            if (o > 1024 * e.const.FORM_UPLOAD_FILE_SIZE * 1024)
                                e.showMessage(e.const.LANG.FORM_UPLOAD_FILE_MAX_SIZE_ERROR, {
          ...
          , J = function(t, i) {
            var a = function(t) {
                t.addEventListener("click", function(i) {
                    i.stopPropagation(),
                    t.classList.contains("accordion-menu") && e.runtime.time_click_dom[t.id] > Date.now() || (e.runtime.time_click_dom[t.id] = Date.now() + 250,
          ...
          , $ = function(t) {
            if (e.runtime.isClient && !e.runtime.isDesktop && !isEmptyLadiPage(e.runtime.bodyFontSize)) {
                ...
                if (1 != i)
                    ...
                    t > Date.now() && e.runTimeout(function() {
                        $(t)
                    }, 100)
            }
        }
                                    ...
                                    if (!(isEmptyLadiPage(p) || isEmptyLadiPage(p.store_info) || isEmptyLadiPage(p.product))) {
                                          ...
                                          , g = function(t) {
                                            e.updateProductVariantSelectOption(t, r, l, o, function() {
                                                if (o) {
                                                    ...
                                                    if (isEmptyLadiPage(d))
                                                        return;
                                                    for (var s = document.querySelectorAll("#POPUP_PRODUCT .ladi-element"), l = 0; l < s.length; l++)
                                                        s[l].id != i && e.runtime.tmp.runLadiSaleProductKey(s[l].id, !1, !0, d, a)
                                                } else
                                        ...
                                        e.showParentVisibility(s, function() {
                                            ...
                                            for (o = 0; o < c.length; o++)
                                                n[c[o].getAttribute("data-store-id") + "_" + c[o].getAttribute("data-product-id") + "_" + c[o].getAttribute("data-product-option-id")] = tt(c[o]);
                                            s.innerHTML = m;
                                            for (var u = null, p = null, y = s.querySelectorAll("select.ladi-form-control"), f = 0; f < y.length; f++)
                                                ...
                                                isNullLadiPage(u) && (p = y[f].querySelector("option"),
                                                isEmptyLadiPage(p) || (u = p.getAttribute("value"))),
                                                y[f].value = u;
                                            var v = s.querySelectorAll(".ladi-form-label-container");
                                            for (f = 0; f < v.length; f++) {
                                                for (var P = v[f].querySelectorAll(".ladi-form-label-item"), h = 0; h < P.length; h++)
                                                    e.tapEventListener(P[h], _);
                                                u = n[v[f].getAttribute("data-store-id") + "_" + v[f].getAttribute("data-product-id") + "_" + v[f].getAttribute("data-product-option-id")],
                                                isNullLadiPage(u) && (p = P[1],
                                                isEmptyLadiPage(p) || (u = Z(p))),
                                                Q(v[f], u)
                                            }
                                            if (e.updateProductVariantSelectOptionFirst(r, l, s),
                                            l["option.product_variant_type"] != e.const.PRODUCT_VARIANT_TYPE.combined)
                                                s.style.setProperty("height", "auto"),
                                                i = s.clientHeight,
                                                s.style.removeProperty("height"),
                                                i > 0 && t != i && (s.style.setProperty("height", i + "px"),
                                                e.updateHeightElement(!0, s, d, t, i));
                                                ...
                                                for (var L = 0; L < y.length; L++) {
                                                    ...
                                                    isEmptyLadiPage(E) || y[L].value == E.getAttribute("value") || (y[L].value = E.getAttribute("value"),
                                                    e.fireEvent(y[L], "change"))
                                                }
                                        })
                                    }
                                }
                ...
                !isEmptyLadiPage(o)) {
                    ...
                    if (isEmptyLadiPage(r)) {
                        ...
                        for (s = 0; s < c.length; s++)
                            ...
                            isEmptyLadiPage(r) && (l = e.runtime.eventData[c[s].id],
                            isEmptyLadiPage(l) || l["option.product_type"] != n["option.product_type"] || l["option.product_id"] != n["option.product_id"] || d.push(c[s]))
                    } else
                        d = r.querySelectorAll("[data-runtime-id]");
                    for (s = 0; s < d.length; s++)
                        if (l = e.runtime.eventData[d[s].id],
                        !isEmptyLadiPage(l) && !isEmptyLadiPage(l["option.product_mapping_name"])) {
          ...
          , nt = function(i, a, n, o, r, d, s, l) {
            ...
            if (!isEmptyLadiPage(c)) {
                ...
                if (d)
                    ...
                    if (isEmptyLadiPage(c) || isEmptyLadiPage(c["option.product_type"]) || isEmptyLadiPage(c["option.product_id"]) || isEmptyLadiPage(u))
                        return;
                    ...
                    !isEmptyLadiPage(s))) {
                        if (c["option.product_id"] != s.target.getAttribute("data-product-id"))
                            return;
                    ...
                    if ("form" == m && c["option.is_add_to_cart"])
                        return c["option.product_id"] = o.product_id,
                ...
                if ("image" == m) {
                    ...
                    isEmptyLadiPage(L))
                        return;
                    b = e.getOptimizeImage(y, L.clientWidth, L.clientHeight, !0, !1, !1, t),
                ...
                if ("gallery" == m) {
                    ...
                    for (var C = L.getElementsByClassName("ladi-gallery-control-item"), N = function(t) {
                        ...
                        L.getElementsByClassName("ladi-gallery-control-box")[0].appendChild(k)
                    }
                    for (; C.length > y.length; )
                        C[C.length - 1].parentElement.removeChild(C[C.length - 1]);
                    E = "style_add_to_cart_gallery_" + i;
                    var I = "";
                    y.length <= 1 && (I += "#" + i + " .ladi-gallery .ladi-gallery-view .ladi-gallery-view-arrow {display: none;}",
                    I += "#" + i + " > .ladi-gallery > .ladi-gallery-view {height: 100%;}",
                    I += "#" + i + " > .ladi-gallery > .ladi-gallery-control {display: none;}");
                    ...
                    y.forEach(function(a, n) {
                        ...
                        I += "#" + i + ' .ladi-gallery .ladi-gallery-view-item[data-index="' + n + '"] {background-image: url("' + b + '");}',
                        b = e.getOptimizeImage(a.src, x.clientWidth, x.clientHeight, !0, !1, !1, t),
                        I += "#" + i + ' .ladi-gallery .ladi-gallery-control-item[data-index="' + n + '"] {background-image: url("' + b + '");}'
                    }),
                    L.setAttribute("data-max-item", y.length),
                    L.setAttribute("data-loaded", !0),
                    e.createStyleElement(E, I)
                }
            }
        }
          , ot = function(t) {
          ...
          , st = function(t, i) {
            ...
            for (o = document.querySelectorAll(".ladi-section:not(#" + e.runtime.builder_section_popup_id + ")"),
            r = 0; r < o.length; r++)
          ...
          , lt = function(t, i, a) {
            ...
            !isEmptyLadiPage(n) && !isEmptyLadiPage(o)) {
                ...
                if ("popup" == n.type) {
                    ...
                    g)
                        return m == e.const.POSITION_TYPE.default ? ot({
          ...
          , pt = function() {
            ...
            _.forEach(function(i) {
                ...
                isEmptyLadiPage(n) ? (function(t, i, a, n, o, r) {
                    ...
                    if (!isEmptyLadiPage(d) && (R(t),
                    "section" == i && !isEmptyLadiPage(o) && !isEmptyLadiPage(r))) {
                        ...
                        isEmptyLadiPage(s) || (e.runtime.list_scroll_func[t] = function() {
                            if ((!e.runtime.isDesktop || a == e.const.BACKGROUND_STYLE.video) && (e.runtime.isDesktop || n == e.const.BACKGROUND_STYLE.video)) {
                                ...
                                o == e.const.VIDEO_TYPE.youtube && (i = '<iframe id="' + d + '" class="ladi-section-background-video" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0;" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"></iframe>',
                                s.innerHTML += i,
                                e.runEventPlayVideo(d, o, r, !0, !0, !1)),
                                o == e.const.VIDEO_TYPE.direct && (i = '<video id="' + d + '" class="ladi-section-background-video" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover;"></video>',
                                s.innerHTML += i,
                                e.runEventPlayVideo(d, o, r, !0, !0, !1))
                            }
                        }
                ...
                function(t, i, a) {
                    e.runtime.list_loaded_func.push(function() {
                        var n = 0;
                        if (-1 != ["headline", "paragraph", "list_paragraph"].indexOf(i) && (n = 1e3),
                        !isArrayLadiPage(a)) {
                            var o = e.copy(a);
                            a = [],
                            isObjectLadiPage(o) && (o.action_type = e.const.ACTION_TYPE.action,
                            a.push(o))
                        }
                        e.runTimeout(function() {
                ...
                function(t, i, a, n, o, r, d) {
                    if ("video" == i && !isEmptyLadiPage(a)) {
                        ...
                        if (!isEmptyLadiPage(s)) {
                            var l = function() {
                                var i = e.runtime.eventData[t];
                                isEmptyLadiPage(i) || (n = i["option.video_type"],
                            ...
                            if (c) {
                                var u = function() {
                                    l(),
                                    e.playVideo(t, n, a, o, c)
                                }
                                  , p = e.findAncestor(s, "ladi-popup");
                                isEmptyLadiPage(p) ? e.runtime.list_scroll_func[t] = u : (p = e.findAncestor(p, "ladi-element"),
                            ...
                            s.addEventListener("click", function(i) {
                                i.stopPropagation(),
                                l(),
                                n == e.const.VIDEO_TYPE.direct && "VIDEO" == i.target.tagName || n == e.const.VIDEO_TYPE.youtube && "IFRAME" == i.target.tagName || e.playVideo(t, n, a, o)
                            })
                        }
                    }
                ...
                function(t, i, a, n) {
                    "popup" == i && a && ((isEmptyLadiPage(n) || n < 0) && (n = 0),
                    e.runTimeout(function() {
                        window.ladi(t).show()
                    }, 1e3 * n))
                ...
                function(t, i, a) {
                    if ("form_item" == i) {
                        var n = null
                          , o = null;
                        if ((a == e.const.INPUT_TYPE.select || a == e.const.INPUT_TYPE.select_multiple) && (n = document.getElementById(t),
                        !isEmptyLadiPage(n)))
                        ...
                        if (a == e.const.INPUT_TYPE.checkbox) {
                            ...
                            if (!isEmptyLadiPage(n)) {
                                ...
                                for (var c = 0; c < o.length; c++) {
                                    ...
                                    o[c].getElementsByTagName("span")[0].addEventListener("click", l),
                        ...
                        if (a == e.const.INPUT_TYPE.radio) {
                            ...
                            var p = function(t) {
                                ...
                                if (!isEmptyLadiPage(a)) {
                                    for (var n = a.querySelectorAll(".ladi-form-checkbox-item span"), o = 0; o < n.length; o++)
                            ...
                            if (!isEmptyLadiPage(n)) {
                                ...
                                for (var g = 0; g < o.length; g++) {
                                    ...
                                    o[g].getElementsByTagName("span")[0].addEventListener("click", m),
                                    _.addEventListener("change", p)
                                }
                            }
                        }
                    }
                    ...
                    if ("survey" == i) {
                        ...
                        if (!isEmptyLadiPage(o)) {
                            ...
                            for (var r, d = o.getElementsByClassName("ladi-survey-select-item")[0], s = o.getElementsByClassName("ladi-survey-radio-item"), l = o.getElementsByClassName("ladi-survey-checkbox-item"), c = o.getElementsByClassName("ladi-survey-option"), u = o.querySelector(".ladi-survey-button-next button"), p = [], m = n.mapping_form_name, g = n.mapping_form_id, _ = n.input_name, y = e.findAncestor(o, ["ladi-form", "ladi-element"]), f = e.runtime.eventData[t]["option.data_event"], v = function() {
                                ...
                                g.forEach(function(t) {
                                    ...
                                    if (!isEmptyLadiPage(o)) {
                                        ...
                                        for (w = 0; w < s.length; w++) {
                                            s[w].getAttribute("name") == n && (l = e.findAncestor(s[w], "ladi-element"),
                                            d.push(l.id));
                                        ...
                                        if (0 == (d = d.unique()).length) {
                                            c++,
                                            (l = document.createElement("div")).className = "ladi-element ladi-hidden ladi-form-item-survey",
                                            l.id = e.randomString(10),
                                            l.setAttribute("data-name", n);
                                            var m = "";
                                            ...
                                            m += "</div>",
                                            l.innerHTML = m,
                                            o.getElementsByClassName("ladi-form")[0].appendChild(l),
                                            d.push(l.id)
                                        }
                                        for (w = 0; w < d.length; w++)
                                            window.ladi(d[w]).value(i)
                                    }
                                })
                            }, P = function() {
                                ...
                                if (!(!isEmptyLadiPage(d) || s.length > 0 || l.length > 0)) {
                                    for (var t = [], i = 0; i < c.length; i++)
                                        c[i].classList.contains("selected") && t.push(c[i].getAttribute("data-value"));
                                ...
                                p.push(c[w].getAttribute("data-value")),
                                E(c[w]);
                            ...
                            for (w = 0; w < l.length; w++)
                                p.push(l[w].getElementsByTagName("input")[0].value),
                                r = l[w],
                                b(r);
                            if (isEmptyLadiPage(y)) {
            ...
            function() {
                for (var t = document.querySelectorAll(".ladi-form .ladi-element .ladi-form-otp"), i = function(t, a) {
                    ...
                    if (!isEmptyLadiPage(n) && (n = e.findAncestor(n, "ladi-element"),
                    !isEmptyLadiPage(n))) {
                    ...
                    if (!isEmptyLadiPage(a) && (a = e.findAncestor(a, "ladi-element"),
                    !isEmptyLadiPage(a))) {
                        var n = "_otp_time_" + a.id
                          ...
                          , d = function() {
                            ...
                            var d = new Date;
                            d.setTime(d.getTime() + e.runtime.time_otp),
                            o ? (r[n] = Date.now(),
                            e.runtime.tmp["cookie_cache_otp_" + a.id] = r) : window.ladi(n).set_cookie(Date.now(), d);
                        ...
                        if ("true" != a.getAttribute("data-start-countdown-otp")) {
                            ...
                            isEmptyLadiPage(s) && isObjectLadiPage(r) && !isEmptyLadiPage(r[n]) && (s = r[n],
                            o = !0);
                            var l = (s = parseFloatLadiPage(s) || 0) + e.runtime.time_otp - Date.now();
                            l = l < e.runtime.time_otp ? l : 0,
                            (s <= 0 || l <= 0) && "true" != t.target.getAttribute("data-click") && isFunctionLadiPage(e.runtime.func_get_code_otp[a.id]) && (e.removeTimeout(e.runtime.tmp.timeout_is_wait_popup_id),
                    ...
                    if (!isEmptyLadiPage(r)) {
                        ...
                        d.innerHTML = e.const.LANG.GET_CODE_BUTTON_TEXT,
                    ...
                    if ("countdown" == i.type)
                        for (var a = document.querySelectorAll("#" + t), n = 0; n < a.length; n++) {
                            ...
                            if (o.hasAttribute("data-date-start") || o.hasAttribute("data-date-end"))
                                ...
                                s = parseFloatLadiPage(o.getAttribute("data-date-end")) || 0;
                            else {
                                if (r == e.const.COUNTDOWN_TYPE.countdown) {
                                    var c = parseInt(o.getAttribute("data-minute")) || 0;
                                    if (c <= 0)
                                        return;
                                    for (s = e.runtime.timenow; s <= l; )
                                        s += 60 * c * 1e3
                                }
                                if (r == e.const.COUNTDOWN_TYPE.endtime && (s = parseInt(o.getAttribute("data-endtime")) || 0),
                                ...
                                o.setAttribute("data-date-end", s)
                            }
                            if (d > l)
                                return;
                            var g = s - l;
            ...
            e.runtime.interval_gallery = e.runInterval(U, 1e3),
            _.forEach(function(t) {
                var i = e.runtime.eventData[t];
                if ("carousel" == i.type) {
                    var a = document.getElementById(t);
                    if (!isEmptyLadiPage(a)) {
                        ...
                        var d = function(i) {
                            ...
                            !isEmptyLadiPage(e.runtime.timenext_carousel[t]) && e.runtime.timenext_carousel[t] > Date.now() || i.target.classList.contains("ladi-carousel-arrow") || (e.runtime.timenext_carousel[t] = Date.now() + 864e5,
                        ...
                        if (!isEmptyLadiPage(a) && "true" == a.getAttribute("data-scrolled") && "true" != a.getAttribute("data-stop")) {
                            ...
                            r > 0) {
                                var d = a.getAttribute("data-next-time")
                                  , s = Date.now();
                                isEmptyLadiPage(d) && (d = s + 1e3 * (r - 1),
                                a.setAttribute("data-next-time", d)),
                                s >= d && (X(t, !0),
                                a.setAttribute("data-next-time", s + 1e3 * r))
                            }
                        }
                    }
                })
            ...
            function() {
                                ...
                                if (!isEmptyLadiPage(u)) {
                                    ...
                                    if (isEmptyLadiPage(p) || isEmptyLadiPage(p["option.data_submit_form_id"])) {
                                        if (!u["option.is_form_login"] && !u["option.is_form_coupon"]) {
                                            ...
                                            isEmptyLadiPage(m) || (m = e.findAncestor(m, "ladi-element")),
                                            isEmptyLadiPage(m) || "POPUP_CHECKOUT" != m.id || e.runtime.tmp.list_form_checkout.push(c.id)
                                        }
                ...
                for (var y = function(t) {
                    ...
                    for (var v = document.querySelectorAll("#" + e.runtime.tmp.list_form_checkout[f] + " .ladi-form-item input.ladi-form-control"), P = 0; P < v.length; P++)
                        -1 != t.indexOf(v[P].getAttribute("name")) && (v[P].addEventListener("change", y),
                        v[P].addEventListener("input", y))
            }(),
            B(),
            t && (e.runtime.is_popupx || e.const.TIME_ONPAGE_TRACKING.forEach(function(t) {
                e.runTimeout(function() {
                    LadiPageTrackingCommand.push(function() {
                        return isFunctionLadiPage(window.gtag)
                    }, function() {
                        ...
                        if (!isEmptyLadiPage(m)) {
                            ...
                            if (0 != g.length) {
                                var _ = !1
                                  ...
                                  , f = function(i, a, n, o) {
                                    if (!_) {
                                        isEmptyLadiPage(i) || (i.classList.remove("in"),
                                        i.classList.add("out"));
                                  ...
                                  , v = function(i, a, n, o) {
                                    if (!_) {
                                        ...
                                        isEmptyLadiPage(i) || (i.classList.add("in"),
                                        i.classList.remove("out"));
                                        var s = isEmptyLadiPage(i) ? null : i.nextSibling;
                                        isEmptyLadiPage(s) ? ((d.classList.contains("rotate-2") || d.classList.contains("rotate-3") || d.classList.contains("scale")) && r.style.setProperty("width", a.clientWidth + "px"),
                                        isEmptyLadiPage(e.findAncestor(a, "type")) || e.runTimeout(function() {
                                  ...
                                  , L = function(t, i) {
                                    _ || (isEmptyLadiPage(e.findAncestor(t, "type")) ? isEmptyLadiPage(e.findAncestor(t, "clip")) || (e.findAncestor(t, "ladipage-animated-words-wrapper").style.setProperty("width", t.clientWidth + 5 + "px"),
                                    e.runTimeout(function() {
                                        E(t)
                                    }, s + l)) : (v(t.querySelectorAll("i")[0], t, !1, i),
                                    ...
                                    if (!_ && !isEmptyLadiPage(l)) {
                                        ...
                                        if (isEmptyLadiPage(e.findAncestor(l, "type")))
                                            if (isEmptyLadiPage(e.findAncestor(l, "letters")))
                                                isEmptyLadiPage(e.findAncestor(l, "clip")) ? isEmptyLadiPage(e.findAncestor(l, "loading-bar")) ? (h(l, c),
                                                e.runTimeout(function() {
                                                    E(c)
                                                }, t)) : (e.findAncestor(l, "ladipage-animated-words-wrapper").classList.remove("is-loading"),
                                                h(l, c),
                                                e.runTimeout(function() {
                                                    E(c)
                                                }, i),
                                                ...
                                                }, a)) : (e.findAncestor(l, "ladipage-animated-words-wrapper").style.setProperty("width", "2px"),
                                                e.runTimeout(function() {
                                                    h(l, c),
                                                    L(c)
                                                }, s));
                                                ...
                                                f(l.querySelectorAll("i")[0], l, u, n),
                                            ...
                                            e.runTimeout(function() {
                                                ...
                                                for (var t = l.querySelectorAll("i"), e = 0; e < t.length; e++)
                                ...
                                !isEmptyLadiPage(e.findAncestor(m, "type")) || !isEmptyLadiPage(e.findAncestor(m, "loading-bar")) || !isEmptyLadiPage(e.findAncestor(m, "clip"))) {
                                    ...
                                    for (var w = getComputedStyle(m).color, T = m.getElementsByClassName("after"), S = 0; S < T.length; S++)
            ...
            function() {
                for (var t = document.querySelectorAll(".ladi-button-group > .ladi-element"), i = function(t) {
                    ...
                    if (!isEmptyLadiPage(a))
                        for (var n = (a = e.findAncestor(a, "ladi-element")).querySelectorAll(".ladi-button-group > .ladi-element"), o = 0; o < n.length; o++)
                ...
                if (0 != t.length) {
                    ...
                    if (!isEmptyLadiPage(i)) {
                        ...
                        if (isEmptyLadiPage(r)) {
                            ...
                            e.loadScript(e.const.LADISALES_SDK, {
                                id: d,
                                "data-time": e.runtime.timenow
                            }, !0)
                        }
                                                        ...
                                                        if (!isEmptyLadiPage(_)) {
                                                            ...
                                                            if (!isEmptyLadiPage(y)) {
                                                                ...
                                                                if (!isEmptyLadiPage(f)) {
                                                                    ...
                                                                    if (!isEmptyLadiPage(v) && !isEmptyLadiPage(v["option.product_variant_id"]))
                                                                        continue
                                                                }
                                                                var P = null
                                                                  , h = null
                                                                ...
                                                                if (_["option.product_variant_type"] == e.const.PRODUCT_VARIANT_TYPE.combobox) {
                                                                    if (!isArrayLadiPage(u.product.variants))
                                                                        continue;
                                                                    if (h = u.product.variants[p],
                                                                    isStringLadiPage(h.option_ids))
                                                                        for (L = h.option_ids.split("/"),
                                                                        E = 0; E < L.length; E++)
                                                                            P = document.querySelector("#" + m[g].id + ' .ladi-form-item select[data-product-option-id="' + L[E] + '"]'),
                                                                            isEmptyLadiPage(P) || P.getAttribute("data-store-id") != u.store_info.id || P.getAttribute("data-product-id") != h.product_id || (P.value = h["option" + (E + 1)])
                                                                }
                                                                if (_["option.product_variant_type"] == e.const.PRODUCT_VARIANT_TYPE.label) {
                                                                    ...
                                                                    isStringLadiPage(h.option_ids))
                                                                        ...
                                                                        E = 0; E < L.length; E++)
                                                                            ...
                                                                            isEmptyLadiPage(P) || P.getAttribute("data-store-id") != u.store_info.id || P.getAttribute("data-product-id") != h.product_id || e.runtime.tmp.updateLabelValue(P, h["option" + (E + 1)])
                                                                }
                                                                if (_["option.product_variant_type"] == e.const.PRODUCT_VARIANT_TYPE.combined) {
                                                                    if (P = m[g].querySelector("select.ladi-form-control"),
                    ...
                    if ("cart" == a) {
                        ...
                        if (!isEmptyLadiPage(n)) {
                            ...
                            isEmptyLadiPage(o) || e.showParentVisibility(o, function() {
                                ...
                                o.hasAttribute("data-height") || (o.setAttribute("data-height", i),
                                a = i);
                                ...
                                if (i != (d = d < a ? a : d)) {
                                    ...
                                    isEmptyLadiPage(s) && (s = e.findAncestor(o.parentElement, "ladi-section")),
                                    e.updateHeightElement(!0, o, s, i, d)
                                }
                            })
                        }
                    }
        ...
        e.runtime.tmp.runElementClickSelected = J,
        e.runtime.tmp.runTrackingAnalytics = C,
        e.runtime.tmp.runLadiSaleProductKey = nt,
        e.runtime.tmp.eventClickGalleryControlItem = G,
        e.runtime.tmp.runGallery = H,
        e.runtime.tmp.setGalleryStart = W,
        e.runtime.tmp.updateImageGalleryProduct = at,
        e.runtime.tmp.runOptionCountdown = F,
        e.runtime.tmp.runOptionCountdownItem = q,
        e.runtime.tmp.getOptionLabelValue = Z,
        e.runtime.tmp.updateLabelValue = Q,
        e.runtime.tmp.getLabelValue = tt,
        e.runtime.tmp.clickLabelProductChangeCallback = et,
        ...
        ,
        e.runtime.tmp.showPopupX = lt,
        e.runtime.tmp.runActionPopupX = ot,
        e.runtime.is_popupx ? (e.runtime.tmp.popupx_iframe_id = e.randomId(),
        ot({
            ladipage_id: e.runtime.ladipage_id,
            action: {
            ...
            try {
                ...
                i.iframe_id == e.runtime.tmp.popupx_iframe_id && i.action.value.forEach(function(t) {
                    !function(t, i) {
                        var a = null
                          , n = null;
                        if ("callback_request_with_option" == t && isFunctionLadiPage(e.runtime.tmp["request_callback_id_" + i.callback_id]) && e.runtime.tmp["request_callback_id_" + i.callback_id](i.responseText, i.status, i.httpRequest, i.url),
                        "set_style_device" == t) {
                            if (ut(i.is_desktop),
                            n = document.getElementById(e.runtime.tmp.popupx_current_element_id),
                            isEmptyLadiPage(n))
                                return;
                        ...
                        if ("set_iframe_info" == t) {
                            isEmptyLadiPage(f) && (f = i.ladi_client_id || e.randomId(),
                            ...
                            e.runtime.tmp.popupx_is_inline && (o += ".ladi-section > .ladi-section-close {display: none !important;}"),
                            e.createStyleElement("style_popup_container", o),
                            e.runtime.has_popupx = !0,
                            pt()
                        }
                        "hide_popupx" == t && (a = e.runtime.eventData[i],
                        n = document.getElementById(i),
                        isEmptyLadiPage(a) || isEmptyLadiPage(n) || window.ladi(i).hide()),
                        "show_popupx" == t && lt(i, !0),
                        "show_popupx_inline_iframe" == t && ct(i, !0),
                        "show_message_callback" == t && (isFunctionLadiPage(e.runtime.tmp.popupx_show_message_callback) && e.runtime.tmp.popupx_show_message_callback(),
...
LadiPageScriptV2.prototype.getListProductByTagId = function(t, e, i, a, n) {
    ...
    if (isArrayLadiPage(l) && l.length > 0) {
        ...
        -1 != [o.const.FORM_CONFIG_TYPE.ladisales, o.const.FORM_CONFIG_TYPE.sapo, o.const.FORM_CONFIG_TYPE.haravan, o.const.FORM_CONFIG_TYPE.shopify, o.const.FORM_CONFIG_TYPE.wordpress].indexOf(d)) {
            ...
            ;
            var h = null;
            if (isStringLadiPage(v) && (h = v,
            v = null),
            isNullLadiPage(v)) {
                o.runtime.tmp.product_tag_info[d][f] = !0;
                var L = function() {
                    o.runtime.tmp.product_tag_info[d][f] = !1,
                    isEmptyLadiPage(o.runtime.tmp.timeout_product_tag_info[d][f]) || (o.removeTimeout(o.runtime.tmp.timeout_product_tag_info[d][f]),
                  ...
                  , E = function(t) {
                    ...
                    isObjectLadiPage(v)) {
                        ...
                        if (d != o.const.FORM_CONFIG_TYPE.ladisales && (v.store_info.id = -1),
                            ...
                            for (var r = null, s = function(t) {
                                ...
                                if (isArrayLadiPage(v.products[c].options) && isArrayLadiPage(v.products[c].variants)) {
                                    ...
                                    for (var p = 0; p < v.products[c].variants.length; p++)
                                        ...
                                        -1 != [o.const.FORM_CONFIG_TYPE.sapo, o.const.FORM_CONFIG_TYPE.haravan, o.const.FORM_CONFIG_TYPE.shopify].indexOf(d) && 1 == v.products[c].variants.length && "Default Title" == v.products[c].variants[p].title && (v.products[c].variants[p].title = null,
                                        v.products[c].variants[p].option1 = null,
                                        v.products[c].options = []),
                                        -1 != [o.const.FORM_CONFIG_TYPE.wordpress].indexOf(d) && 1 == v.products[c].variants.length && v.products[c].variants[p].title == v.products[c].variants[p].product_name && (v.products[c].variants[p].title = null,
                                        v.products[c].variants[p].option1 = null,
                                        v.products[c].options = []),
                                        isEmptyLadiPage(v.products[c].variants[p].package_quantity) || isEmptyLadiPage(v.products[c].variants[p].package_quantity_unit) || (isNullLadiPage(v.products[c].variants[p].title_old) && (v.products[c].variants[p].title_old = v.products[c].variants[p].title),
                                        v.products[c].variants[p].title = v.products[c].variants[p].title_old + " (" + v.products[c].variants[p].package_quantity + " " + v.products[c].variants[p].package_quantity_unit + ")");
                                    if (isArrayLadiPage(v.products[c].options) && 1 == v.products[c].options.length && isArrayLadiPage(v.products[c].options[0].values))
                                        for (var m = 0; m < v.products[c].options[0].values.length; m++) {
                                            ...
                                            isEmptyLadiPage(g) || isEmptyLadiPage(g.package_quantity) || isEmptyLadiPage(g.package_quantity_unit) || (v.products[c].options[0].values[m].name_new = v.products[c].options[0].values[m].name_new + " (" + g.package_quantity + " " + g.package_quantity_unit + ")")
                                        }
                                }
                        ...
                        o.runtime.tmp.product_tag_info[d][f] = v,
                        _ = y(),
                ...
                return o.runLimitRequest(20, function() {
                    if (o.runtime.isClient) {
                        ...
                        d == o.const.FORM_CONFIG_TYPE.ladisales ? ((A = {
                            "Content-Type": "application/json"
                        })["Store-Id"] = s,
                        b = JSON.stringify(b)) : d == o.const.FORM_CONFIG_TYPE.wordpress ? (w = "GET",
                        a = window.location.origin + "/ladipage/api?action=product_list&category_ids=" + l.join("|") + "&page=" + i + "&limit=" + e,
                        b = null) : (A = {
                            "Content-Type": "application/json"
                        },
...
LadiPageScriptV2.prototype.getCartProducts = function() {
      ...
      , e = function() {
        ...
        return t.runtime.tmp.cart.forEach(function(t) {
            if (!(t.quantity <= 0)) {
                ...
                isObjectLadiPage(t.promotion) && a.push([t.promotion.discount.discount_id, t.promotion.discount.note, t.promotion.total].join(":")),
                a = a.join("|"),
                e.push(a)
            }
        }),
    ...
    if (-1 != [t.const.FORM_CONFIG_TYPE.sapo, t.const.FORM_CONFIG_TYPE.haravan, t.const.FORM_CONFIG_TYPE.shopify, t.const.FORM_CONFIG_TYPE.wordpress].indexOf(t.runtime.shopping_product_type))
        return e();
...
LadiPageScriptV2.prototype.getCartCheckoutPrice = function(t) {
    ...
    if (-1 != [this.const.FORM_CONFIG_TYPE.sapo, this.const.FORM_CONFIG_TYPE.haravan, this.const.FORM_CONFIG_TYPE.shopify, this.const.FORM_CONFIG_TYPE.wordpress].indexOf(this.runtime.shopping_product_type))
...
LadiPageScriptV2.prototype.createCartData = function(t) {
    ...
    if (isEmptyLadiPage(e.runtime.shopping_product_type) || window.ladi("_shopping_product_type").get_cookie() != e.runtime.shopping_product_type && (window.ladi("_cart_token").delete_cookie(),
    window.ladi("_checkout_token").delete_cookie(),
    window.ladi("_shopping_product_type").set_cookie(e.runtime.shopping_product_type, 30)),
    -1 == [e.const.FORM_CONFIG_TYPE.sapo, e.const.FORM_CONFIG_TYPE.haravan, e.const.FORM_CONFIG_TYPE.wordpress].indexOf(e.runtime.shopping_product_type))
        if (-1 == [e.const.FORM_CONFIG_TYPE.shopify].indexOf(e.runtime.shopping_product_type)) {
            ...
            if (!isEmptyLadiPage(a))
                return n["cart-token"] = a,
                void this.sendRequest("POST", this.const.API_LADISALE_SHOW, JSON.stringify({
                    type: "LP"
                }), !0, n, function(t, a, n) {
                    if (n.readyState == XMLHttpRequest.DONE) {
                        if (200 == a)
                            try {
                                var o = JSON.parse(t);
                                200 == o.code && (e.runtime.tmp.ladisales_checkout_url = o.data.url,
                                o.data.items.forEach(function(t) {
                                    ...
                                    var a = e.runtime.tmp.cart.findIndex(function(e) {
                                      ...
                                      , r = t.option_name
                                      , d = t.price;
                                    if (isEmptyLadiPage(t.package_quantity) || isEmptyLadiPage(t.package_quantity_unit) || (r = r + " (" + t.package_quantity + " " + t.package_quantity_unit + ")"),
                                    -1 == a) {
                                        var s = {
                                            store_id: t.store_id,
                                        ...
                                        isObjectLadiPage(s.currency) && !isEmptyLadiPage(s.currency.code) && (s.currency.symbol = e.formatCurrency(null, s.currency.code, !1, !0)),
                                        e.runtime.tmp.cart.push(s)
                                    }
                                }),
                                e.updateCartPromotion())
                            } catch (t) {}
            ...
            e.getCheckoutShopify(null, function(t, a) {
                e.updateCartPromotion(null, !0, i)
            }, function() {
                e.updateCartPromotion(null, !0, i)
            });
    else
        this.updateCartPromotion(null, !0, i)
}
,
LadiPageScriptV2.prototype.changeTotalPriceCart = function(t) {
    ...
    if (this.runtime.tmp.cart.length > 0 && !isEmptyLadiPage(this.runtime.tmp.cart[0].currency) && !isEmptyLadiPage(this.runtime.tmp.cart[0].currency.symbol)) {
        ...
        s = this.formatCurrency(a, c, !0),
        l = this.formatCurrency(n, c, !0)
    }
...
LadiPageScriptV2.prototype.removeAddToCartProduct = function(t, e, i, a) {
    ...
    try {
        t = decodeURIComponentLadiPage(t),
        o = JSON.parse(t)
    } catch (t) {}
    var r = function(t) {
    ...
    -1 != d && (n.showLoadingBlur(),
    n.updateCartCookie({
        cart_item_key: n.runtime.tmp.cart[d].cart_item_key,
        product_variant_id: this.runtime.tmp.cart[d].product_variant_id,
        quantity: 0
    }, i, function() {
        -1 != (d = n.runtime.tmp.cart.findIndex(r)) && n.runtime.tmp.cart.splice(d, 1),
        ...
        e && n.showMessage(t.message),
        isFunctionLadiPage(a) && a(!1)
    }, n.hideLoadingBlur))
}
,
    ...
    if (isArrayLadiPage(this.runtime.tmp.cart) && 0 != this.runtime.tmp.cart.length) {
        ...
        if (!isEmptyLadiPage(i)) {
            ...
            if (!isEmptyLadiPage(a)) {
                ...
                a.value = n + e < a.getAttribute("min") ? a.getAttribute("min") : n + e,
...
LadiPageScriptV2.prototype.changeAddToCartProductQuantity = function(t, e, i) {
    ...
    try {
        e = decodeURIComponentLadiPage(e),
        n = JSON.parse(e)
    } catch (t) {}
    var o = function(t) {
    ...
    if (-1 != r) {
        ...
        isEmptyLadiPage(p) || (l = p.min_buy || l,
        c = p.max_buy);
        var m = this.runtime.tmp.cart[r].quantity;
        if (isEmptyLadiPage(t.value))
            i && (t.value = l),
            this.runtime.tmp.cart[r].quantity = l;
        else {
            var g = parseInt(t.value) || 0;
            1 == this.runtime.tmp.cart[r].inventory_checked && g > (s = this.runtime.tmp.cart[r].available_quantity) && (g = s,
            d = !0,
            u = s),
            g = g < l ? l : g,
            !isEmptyLadiPage(c) && g > c && (g = c,
            d = !0,
            (isEmptyLadiPage(u) || u > c) && (u = c)),
            this.runtime.tmp.cart[r].quantity = g,
            t.value = g
        }
        d && this.showMessage(this.const.LANG.ADD_TO_CART_MAX_QUANTITY, {
            max: u,
            name: a.getMessageNameProduct(p)
        });
        var _ = this.runtime.tmp.cart[r].quantity;
        if (m == _)
            return void (t.value = m);
        var y = {
        ...
        this.updateCartCookie(y, !1, function() {
            var t = document.getElementsByClassName("ladi-form-remove-coupon")[0];
            isEmptyLadiPage(t) || t.click(),
            a.updateCartPromotion()
        }, function(t) {
            a.runtime.tmp.cart[r].quantity -= _ - m,
            a.showMessage(t.message)
        }, function() {
            if (a.changeTotalPriceCart(),
                ...
                for (var n = document.querySelectorAll(".ladi-cart-price span[data-product-variant-id]"), d = 0; d < n.length; d++)
                    if (n[d].getAttribute("data-store-id") == a.runtime.tmp.cart[r].store_id && n[d].getAttribute("data-product-id") == a.runtime.tmp.cart[r].product_id) {
                        if (isEmptyLadiPage(a.runtime.tmp.cart[r].cart_item_key)) {
                            if (n[d].getAttribute("data-product-variant-id") != a.runtime.tmp.cart[r].product_variant_id)
                                continue
                        } else if (n[d].getAttribute("data-cart-item-key") != a.runtime.tmp.cart[r].cart_item_key)
                            continue;
                        n[d].innerHTML = i;
                        ...
                        if (!isEmptyLadiPage(s)) {
                            ...
                            if (!isEmptyLadiPage(l) && !isEmptyLadiPage(c) && l.id == c.id)
                                continue;
...
LadiPageScriptV2.prototype.updateProductVariantSelectOption = function(t, e, i, a, n) {
    ...
    if (isObjectLadiPage(d)) {
        ...
        if (isEmptyLadiPage(l))
            ...
            c = l.querySelectorAll('[data-variant="true"]');
        var y = [];
        for (u = 0; u < c.length; u++) {
            if (a) {
                ...
                if (isEmptyLadiPage(f))
                    continue;
                if ("POPUP_PRODUCT" != (f = o.findAncestor(f, "ladi-element")).id && "POPUP_BLOG" != f.id)
                    continue
            }
            y.push(c[u])
        }
        ...
        if (isArrayLadiPage(d.product.variants) && 0 != d.product.variants.length) {
            if (isStringLadiPage(d.product.variants[0].option_ids)) {
                for (L = d.product.variants[0].option_ids.split("/"),
                u = 0; u < L.length; u++)
                    if (L[u] == v) {
                        h = u;
                        break
                    ...
                    d.product.variants.forEach(function(t) {
                        if (isEmptyLadiPage(E) || E == t["option" + (h + 1)])
                            for (u = 0; u < L.length; u++)
                                isArrayLadiPage(P[L[u]]) || (P[L[u]] = []),
                                u != h && P[L[u]].push(t["option" + (u + 1)])
                    })
                }
            }
            for (var b = P, A = [], w = [], T = null, S = 0; S < y.length; S++) {
                ...
                if (!isEmptyLadiPage(O)) {
                    ...
                    if (O["option.product_variant_type"] == o.const.PRODUCT_VARIANT_TYPE.combobox) {
                        if (T = y[S].querySelectorAll("select[data-product-option-id]"),
                        isObjectLadiPage(P)) {
                            for (C = 0; C < T.length; C++)
                                if ((x = T[C].getAttribute("data-product-option-id")) != v)
                                    for (isArrayLadiPage(P[x]) && -1 != P[x].indexOf(T[C].value) || (T[C].value = ""),
                                    D = T[C].getElementsByTagName("option"),
                                    N = 0; N < D.length; N++)
                                        isEmptyLadiPage(D[N].getAttribute("value")) || D[N].removeAttribute("disabled");
                            for (C = 0; C < T.length; C++) {
                                for (x = T[C].getAttribute("data-product-option-id"),
                                P = {},
                                k = 0; k < d.product.variants.length; k++)
                                    if (F = d.product.variants[k],
                                    L = F.option_ids.split("/"),
                                    -1 != (h = L.indexOf(x)) && (isEmptyLadiPage(T[C].value) || T[C].value == F["option" + (h + 1)]))
                                        for (u = 0; u < L.length; u++)
                                            isArrayLadiPage(P[L[u]]) || (P[L[u]] = []),
                                            u != h && P[L[u]].push(F["option" + (u + 1)]);
                                for (I = 0; I < T.length; I++)
                                    if ((R = T[I].getAttribute("data-product-option-id")) != x)
                                        for (D = T[I].getElementsByTagName("option"),
                                        N = 0; N < D.length; N++)
                    ...
                    if (O["option.product_variant_type"] == o.const.PRODUCT_VARIANT_TYPE.label) {
                        if (T = y[S].querySelectorAll(".ladi-form-label-container[data-product-option-id]"),
                        isObjectLadiPage(P)) {
                            for (C = 0; C < T.length; C++)
                                if ((x = T[C].getAttribute("data-product-option-id")) != v) {
                                    var q = o.runtime.tmp.getLabelValue(T[C]);
                                    for (isArrayLadiPage(P[x]) && -1 != P[x].indexOf(q) || o.runtime.tmp.updateLabelValue(T[C], null),
                            ...
                            for (C = 0; C < T.length; C++) {
                                ...
                                for (I = 0; I < T.length; I++)
                                    if ((R = T[I].getAttribute("data-product-option-id")) != x)
                                        for (D = T[I].getElementsByClassName("ladi-form-label-item"),
                                        N = 0; N < D.length; N++)
            ...
            for (var Y = null; A.length > 0; )
                Y = A.shift(),
                o.fireEvent(Y, "change");
            for (; w.length > 0; )
                Y = w.shift(),
                o.runtime.tmp.fireEventLabelChange(Y);
            for (T = document.querySelectorAll(".ladi-form .ladi-form-label-container"),
            S = 0; S < T.length; S++) {
                var V = o.runtime.tmp.getLabelValue(T[S]);
                if (!isEmptyLadiPage(V))
                    o.findAncestor(T[S], "ladi-element").getAttribute("data-title-type") == o.const.PRODUCT_VARIANT_TITLE.top && (V = ": " + V);
                var j = o.findAncestor(T[S], "ladi-form-item-box");
                isEmptyLadiPage(j) || (j = j.querySelector(".ladi-form-item-title-value"),
                isEmptyLadiPage(j) || (j.innerHTML = V))
            }
        }
    }
}
        ...
        if (isArrayLadiPage(n.product.variants) && 0 != n.product.variants.length) {
            ...
            e["option.product_variant_type"] == a.const.PRODUCT_VARIANT_TYPE.combined)
                for (d = 0; d < o.length; d++)
                    l = o[d].querySelector('option[data-product-variant-id="' + s.product_variant_id + '"]'),
                    isEmptyLadiPage(l) || (o[d].value = l.getAttribute("value"),
            ...
            e["option.product_variant_type"] == a.const.PRODUCT_VARIANT_TYPE.combobox && isStringLadiPage(s.option_ids) && s.option_ids.split("/").forEach(function(t, e) {
                for (d = 0; d < o.length; d++)
                    o[d].getAttribute("data-product-option-id") == t && (o[d].value = s["option" + (e + 1)] || "",
                    a.fireEvent(o[d], "change"))
            }),
            e["option.product_variant_type"] == a.const.PRODUCT_VARIANT_TYPE.label && isStringLadiPage(s.option_ids) && s.option_ids.split("/").forEach(function(t, e) {
                for (d = 0; d < r.length; d++)
                    r[d].getAttribute("data-product-option-id") == t && (a.runtime.tmp.updateLabelValue(r[d], s["option" + (e + 1)] || ""),
    ...
    0 == n.length)
        ...
        n.forEach(function(e, n) {
            if (!(e.quantity <= 0)) {
                ...
                r += "</td>",
                t == a.const.CART_LAYOUT.editable && (r += '<td class="ladi-cart-quantity"><div class="ladi-cart-quantity-content"><div onclick="javascript: LadiPageScript.buttonAddToCartProductQuantity(this, -1);" class="button"><span>-</span></div><input type="number" min="1" value="' + e.quantity + '" oninput="javascript: LadiPageScript.changeAddToCartProductQuantity(this, \'' + o + '\', true);" /><div onclick="javascript: LadiPageScript.buttonAddToCartProductQuantity(this, 1);" class="button"><span>+</span></div></div></td>'),
                r += '<td class="ladi-cart-price"><span' + (isNullLadiPage(e.store_id) ? "" : ' data-store-id="' + e.store_id + '"') + ' data-product-id="' + e.product_id + '" data-product-variant-id="' + e.product_variant_id + '" data-cart-item-key="' + e.cart_item_key + '">';
                ...
                r += l + "</span>",
                isObjectLadiPage(e.promotion) && (s = e.promotion.total,
                l = a.formatNumber(s, 3),
                isObjectLadiPage(e.currency) && !isEmptyLadiPage(e.currency.symbol) && (l = a.formatCurrency(s, e.currency.symbol, !0)),
                r += '<span class="price-compare">' + l + "</span>"),
                r += "</td>",
                t == a.const.CART_LAYOUT.editable && (r += '<td class="ladi-cart-action"><div onclick="javascript: LadiPageScript.removeAddToCartProduct(\'' + o + '\', true);" class="button"><span>X</span></div></td>',
                r += "</tr>")
            }
        })
    }
    ...
    if (!isEmptyLadiPage(a)) {
        ...
        if (!isEmptyLadiPage(n) && (n["option.product_variant_type"] == this.const.PRODUCT_VARIANT_TYPE.combobox || n["option.product_variant_type"] == this.const.PRODUCT_VARIANT_TYPE.label)) {
            ...
            for (var l = 0; l < d.length; l++)
                s[d[l].getAttribute("data-product-option-id")] = (isEmptyLadiPage(d[l].value) ? "" : d[l].value).trim();
            for (d = a.querySelectorAll(".ladi-form-label-container[data-product-option-id]"),
            l = 0; l < d.length; l++)
                s[d[l].getAttribute("data-product-option-id")] = this.runtime.tmp.getLabelValue(d[l]).trim();
    ...
    if (isObjectLadiPage(u) && isObjectLadiPage(u.product)) {
        ...
        var y = function() {
            if (-1 != [s.const.FORM_CONFIG_TYPE.ladisales, s.const.FORM_CONFIG_TYPE.sapo, s.const.FORM_CONFIG_TYPE.haravan, s.const.FORM_CONFIG_TYPE.shopify, s.const.FORM_CONFIG_TYPE.wordpress].indexOf(l)) {
                ...
                if (-1 != ["image"].indexOf(c) && (g = u.product[c],
                isObjectLadiPage(g) && (e = g.src,
                isEmptyLadiPage(e) || !isStringLadiPage(e) || e.startsWith("http://") || e.startsWith("https://") || e.startsWith("//") || (e = "https://" + s.const.STATIC_W_DOMAIN + "/" + e),
                t = !0)),
                ...
                g.forEach(function(t) {
                    isEmptyLadiPage(t.src) || (!isStringLadiPage(t.src) || t.src.startsWith("http://") || t.src.startsWith("https://") || t.src.startsWith("//") ? e.push({
                        ...
                        src: "https://" + s.const.STATIC_W_DOMAIN + "/" + t.src
                    }))
                }),
                t = !0)),
                    ...
                    !t)
                        if (-1 != r)
                            if (-1 != ["variant_start_date", "variant_end_date"].indexOf(c)) {
                                ...
                                g = f[c] || f.product_name,
                                e = g;
                            else if (-1 != ["text_quantity"].indexOf(c))
                                g = 1 == f.inventory_checked ? f[c] : "",
                                e = g;
                                ...
                                isEmptyLadiPage(f[c]) ? g = "" : (g = s.formatNumber(f[c], 3),
                                ...
                                0 != v ? (g = s.formatNumber(v, 3),
                                isObjectLadiPage(u.store_info) && isObjectLadiPage(u.store_info.currency) && !isEmptyLadiPage(u.store_info.currency.symbol) && (g = s.formatCurrency(v, u.store_info.currency.symbol, !0))) : g = "",
                                e = g
                            } else if (-1 != ["price_sale_percent"].indexOf(c)) {
                                var P = 0;
                                isEmptyLadiPage(f.price) || isEmptyLadiPage(f.compare_price) || (P = Math.floor((f.compare_price - f.price) / f.compare_price * 100)),
                                e = g = 0 != P ? P + "%" : ""
                                ...
                                isEmptyLadiPage(g))
                                    return c = "image",
                                    y();
                                !isStringLadiPage(g) || g.startsWith("http://") || g.startsWith("https://") || g.startsWith("//") || (g = "https://" + s.const.STATIC_W_DOMAIN + "/" + g),
                                e = g
                            } else
                ...
                if (g = u.product[c],
                isBooleanLadiPage(g))
                    g = g ? s.const.LANG.OPTION_TRUE : s.const.LANG.OPTION_FALSE;
                else
                    try {
                        (_ = new Date(g)).toISOString() == g && (g = _.getFullYear() + "-" + m(_.getMonth() + 1) + "-" + m(_.getDate()) + " " + m(_.getHours()) + ":" + m(_.getMinutes()) + ":" + m(_.getSeconds()))
                    } catch (t) {}
        ...
        if (!isEmptyLadiPage(_)) {
            ...
            isNullLadiPage(h)) {
                ...
                var E = function() {
                  ...
                  , b = function(t) {
                    if (h = isObjectLadiPage(c.runtime.tmp.product_info[m][_]) ? c.runtime.tmp.product_info[m][_] : t.data,
                    isObjectLadiPage(h)) {
                        ...
                        if (m != c.const.FORM_CONFIG_TYPE.ladisales && (h.store_info.id = -1),
                        ...
                        isObjectLadiPage(h.product) && isArrayLadiPage(h.product.options) && isArrayLadiPage(h.product.variants)) {
                            ...
                            for (var a = 0; a < h.product.variants.length; a++)
                                ...
                                -1 != [c.const.FORM_CONFIG_TYPE.sapo, c.const.FORM_CONFIG_TYPE.haravan, c.const.FORM_CONFIG_TYPE.shopify].indexOf(m) && 1 == h.product.variants.length && "Default Title" == h.product.variants[a].title && (h.product.variants[a].title = null,
                                h.product.variants[a].option1 = null,
                                h.product.options = []),
                                -1 != [c.const.FORM_CONFIG_TYPE.wordpress].indexOf(m) && 1 == h.product.variants.length && h.product.variants[a].title == h.product.variants[a].product_name && (h.product.variants[a].title = null,
                                h.product.variants[a].option1 = null,
                                h.product.options = []),
                                isEmptyLadiPage(h.product.variants[a].package_quantity) || isEmptyLadiPage(h.product.variants[a].package_quantity_unit) || (isNullLadiPage(h.product.variants[a].title_old) && (h.product.variants[a].title_old = h.product.variants[a].title),
                            ...
                            if (isArrayLadiPage(h.product.options) && 1 == h.product.options.length && isArrayLadiPage(h.product.options[0].values))
                                for (var n = null, o = function(t) {
                                    ...
                                    isEmptyLadiPage(d) || isEmptyLadiPage(d.package_quantity) || isEmptyLadiPage(d.package_quantity_unit) || (h.product.options[0].values[r].name_new = h.product.options[0].values[r].name_new + " (" + d.package_quantity + " " + d.package_quantity_unit + ")")
                                }
                        }
                        c.runtime.tmp.product_info[m][_] = h,
                        l = L(),
                        isFunctionLadiPage(s) && s(l)
                    } else
                        E()
                ...
                return c.runLimitRequest(20, function() {
                    if (c.runtime.isClient) {
                        ...
                        A = JSON.stringify(A)) : m == c.const.FORM_CONFIG_TYPE.wordpress ? (T = "GET",
                        t = window.location.origin + "/ladipage/api?action=product_info&product_id=" + _,
                        A = null) : (w = {
                            "Content-Type": "application/json"
                        },
...
LadiPageScriptV2.prototype.reloadFeeShipping = function(t) {
    ...
    var a = function(t, i) {
        ...
        e.changeTotalPriceCart(),
        isNullLadiPage(i) && (e.runtime.tmp.add_to_cart_shipping_method_id = null,
        i = []);
        for (var a = null, n = e.runtime.tmp.add_to_cart_shipping_method_id, o = function(t) {
            ...
            (parseFloatLadiPage(e.runtime.tmp.add_to_cart_shipping_method_id) || 0) == e.runtime.tmp.add_to_cart_shipping_method_id && (e.runtime.tmp.add_to_cart_shipping_method_id = parseFloatLadiPage(e.runtime.tmp.add_to_cart_shipping_method_id) || 0),
            ...
            for ("true" != s.getAttribute("data-event") && (s.setAttribute("data-event", !0),
            s.addEventListener("change", o)),
            isNullLadiPage(s.getAttribute("data-placeholder")) && s.setAttribute("data-placeholder", l[0].innerHTML); l.length > 0; )
                l[0].parentElement.removeChild(l[0]);
            i.length <= 0 && ((a = document.createElement("option")).innerHTML = s.getAttribute("data-placeholder"),
            s.appendChild(a));
            for (var c = 0; c < i.length; c++) {
                ...
                n == i[c].shipping_method_id && a.setAttribute("selected", "selected"),
                s.appendChild(a)
            }
    ...
    e.runtime.tmp.timeout_reload_fee_shipping = e.runTimeout(function() {
        if (0 != e.runtime.tmp.list_form_checkout.length) {
            var n = null;
            if (n = isEmptyLadiPage(t) ? document.getElementById(e.runtime.tmp.list_form_checkout[0]) : e.findAncestor(t.target, "ladi-form"),
            isEmptyLadiPage(n))
                a(0);
            else {
                ...
                if (isEmptyLadiPage(o) || isEmptyLadiPage(r) || isEmptyLadiPage(d))
                    a(0);
                else {
                    var s = o.value
                      , l = r.value
                      , c = d.value;
                    if (isEmptyLadiPage(s) || isEmptyLadiPage(l))
                        return void a(0);
                    var u = {
                        state_id: s.split(":")[0],
                        district_id: l,
                    ...
                    "SELECT" == r.tagName && (u.district_id = u.district_id.split(":")[0],
                    u.district_id = parseInt(u.district_id) || u.district_id),
                    "SELECT" == d.tagName && (u.ward_id = u.ward_id.split(":")[0],
                                    ...
                                    if (200 == n)
                                        try {
                                            for (var r = 0, d = [], c = e.createTmpElement("div", t, null, !1).querySelectorAll('[for^="shippingMethod-"]'), u = 0; u < c.length; u++) {
                                                ...
                                                isEmptyLadiPage(y) || (y = y.querySelector('input[name="shippingMethod"]'),
                                                isEmptyLadiPage(y) || (g = y.value)),
                                                isEmptyLadiPage(p) || isEmptyLadiPage(g) || d.push({
                                                    name: p,
                                                    fee: m,
                    ...
                    if (e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.shopify)
                        return void a(0);
                    ...
                    if (isEmptyLadiPage(_) || isEmptyLadiPage(y))
                        return void a(0);
                    g = {
                        "Content-Type": "application/json",
                        "cart-token": _
                                ...
                                try {
                                    ...
                                    if (200 == o.code) {
                                        ...
                                        if (isArrayLadiPage(o.data.shipping_methods))
                                            -1 == o.data.shipping_methods.findIndex(function(t) {
                                                return t.shipping_method_id == e.runtime.tmp.add_to_cart_shipping_method_id
                                            }) && (e.runtime.tmp.add_to_cart_shipping_method_id = null),
...
LadiPageScriptV2.prototype.getThirdPartyCheckoutUrl = function(t, e) {
    var i = this
      ...
      , n = function(n, o, r) {
        t && (a = i.getLinkUTMRedirect(a, null),
        a = i.convertDataReplaceStr(a, !0),
        window.ladi(a).open_url()),
        isFunctionLadiPage(e) && e(a, n, o, r)
    };
    ...
    -1 != [i.const.FORM_CONFIG_TYPE.ladisales].indexOf(i.runtime.shopping_product_type) && (isNullLadiPage(i.runtime.shopping_config_checkout_id) ? (a = i.runtime.tmp.ladisales_checkout_url,
    n()) : (t && window.ladi("POPUP_CHECKOUT").show(),
    isFunctionLadiPage(e) && e()))
}
,
    ...
    t.getCheckoutSapo(null, function(e, i) {
        ...
        if (!isEmptyLadiPage(n)) {
            ...
            if (!isEmptyLadiPage(r)) {
                ...
                isEmptyLadiPage(d) || (d.value = n.textContent.trim(),
                t.fireEvent(d, "change"),
                t.runtime.tmp.current_use_coupon = d.value,
        ...
        if (!isEmptyLadiPage(n)) {
            ...
            if (!isEmptyLadiPage(o)) {
                ...
                if (!isEmptyLadiPage(d)) {
                    ...
                    isEmptyLadiPage(s) || (s.value = o.getAttribute("data-coupon"),
...
LadiPageScriptV2.prototype.reloadPriceDiscount = function(t) {
    ...
    var i = e.runtime.tmp.current_use_coupon
      , a = function(n, o) {
        ...
        isEmptyLadiPage(d) || (r = e.findAncestor(d, "ladi-form"),
        d.parentElement.removeChild(d));
        var s = document.querySelector('.ladi-form-item input[name="coupon"].pointer-events-none');
        if (isEmptyLadiPage(s) || s.classList.remove("pointer-events-none"),
        !isEmptyLadiPage(e.runtime.tmp.current_use_coupon)) {
            if (isEmptyLadiPage(r) && !isEmptyLadiPage(t) && (r = e.findAncestor(t.target, "ladi-form")),
            isEmptyLadiPage(r))
                return;
            ...
            d.addEventListener("click", function(t) {
                ...
                -1 != [e.const.FORM_CONFIG_TYPE.sapo, e.const.FORM_CONFIG_TYPE.haravan, e.const.FORM_CONFIG_TYPE.shopify, e.const.FORM_CONFIG_TYPE.wordpress].indexOf(e.runtime.shopping_product_type)) {
                    ...
                    isEmptyLadiPage(n) || e.reloadPriceDiscount({
                        isRemoveCoupon: !0,
                        couponOld: i,
                        target: n
                    })
        ...
        if ((i != e.runtime.tmp.current_use_coupon || isEmptyLadiPage(t) || !t.isRemoveCoupon || !isEmptyLadiPage(t.docCrawl)) && e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.haravan) {
            ...
            !isEmptyLadiPage(e.runtime.tmp.current_use_coupon)) {
                ...
                if (!isEmptyLadiPage(l))
                    l = (parseFloatLadiPage(l.getAttribute("data-checkout-subtotal-price-target")) || 0) / 100,
                    e.changeTotalPriceCart(!0).cart_price != l && (e.runtime.tmp.use_cart_line_price_original = !0)
            }
            e.updateCartPromotion()
        }
    };
    isEmptyLadiPage(t) || isEmptyLadiPage(t.discount_price) ? e.runtime.tmp.is_click_check_price_discount || isEmptyLadiPage(t) && isEmptyLadiPage(e.runtime.tmp.current_use_coupon) || (isEmptyLadiPage(e.runtime.tmp.timeout_reload_price_discount) || e.removeTimeout(e.runtime.tmp.timeout_reload_price_discount),
    e.runtime.tmp.timeout_reload_price_discount = e.runTimeout(function() {
        if (0 != e.runtime.tmp.list_form_checkout.length) {
            var i = null;
            if (isEmptyLadiPage(t) ? i = document.getElementById(e.runtime.tmp.list_form_checkout[0]) : (i = e.findAncestor(t.target, "ladi-form"),
            isEmptyLadiPage(i) || (i = i.querySelector("[data-submit-form-id]"),
            isEmptyLadiPage(i) || (i = document.getElementById(i.getAttribute("data-submit-form-id"))))),
            isEmptyLadiPage(i))
                a(0);
            else {
                var n = null
                ...
                if (isEmptyLadiPage(d))
                    ...
                    e.runtime.tmp.current_use_coupon = null;
                    var l = d.value;
                    if (isEmptyLadiPage(l) && (isEmptyLadiPage(t) || !t.isRemoveCoupon))
                        return void a(0);
                    if (isEmptyLadiPage(t) && l != s)
                        return void a(0);
                    n = {
                        discount_code: l
                    },
                    isEmptyLadiPage(o) || (n.email = o.value),
                    isEmptyLadiPage(r) || (n.phone = r.value),
                        ...
                        return u = function(i, o) {
                            ...
                            e.sendRequest("POST", window.location.origin + i.getAttribute("action"), p, !0, c, function(i, n, o) {
                                if (o.readyState == XMLHttpRequest.DONE) {
                                    ...
                                    isEmptyLadiPage(t) || e.showMessage(e.const.LANG.REQUEST_SEND_ERROR),
                                    a(0)
                                }
                            })
                        }
                    ...
                    if (e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.haravan)
                        return u = function(i) {
                            ...
                            isEmptyLadiPage(n.discount_code) ? o.search = o.search + (isEmptyLadiPage(o.search) ? "?" : "&") + "form_name=form_discount_remove" : o.search = o.search + (isEmptyLadiPage(o.search) ? "?" : "&") + "discount.code=" + n.discount_code + "&form_name=form_discount_add",
                            i = o.href,
                    ...
                    if (e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.wordpress) {
                        ...
                        return isEmptyLadiPage(n.discount_code) ? m += "?action=remove_coupon&coupon=" + (isEmptyLadiPage(t) ? "" : t.couponOld) : m += "?action=apply_coupon&coupon=" + n.discount_code,
                            ...
                            if (o.readyState == XMLHttpRequest.DONE) {
                                if (200 == n)
                                    try {
                                        var r = JSON.parse(i);
                                        if (200 == r.code)
                                            return e.runtime.tmp.current_use_coupon = l,
                                            void a(r.data);
                    ...
                    if (isEmptyLadiPage(g) || isEmptyLadiPage(_))
                        return void a(0);
                    c = {
                        "Content-Type": "application/json",
                        "cart-token": g
                        ...
                        if (o.readyState == XMLHttpRequest.DONE) {
                            if (200 == n)
                                try {
                                    var r = JSON.parse(i);
                                    if (200 == r.code)
                                        return isEmptyLadiPage(r.data.discount_error) ? e.runtime.tmp.current_use_coupon = l : isEmptyLadiPage(t) || e.showMessage(r.data.discount_error),
...
LadiPageScriptV2.prototype.updateCartPromotion = function(t, e, i) {
    var a = this
      , n = function(t) {
        for (var e = 0; e < a.runtime.tmp.cart.length; e++) {
            ...
            if (i.product_id == t.product_id && i.product_variant_id == t.product_variant_id) {
                a.runtime.tmp.use_cart_line_price_original || t.sub_total == t.total ? delete i.promotion : i.promotion = t,
                ...
                for (var n = document.querySelectorAll('.ladi-cart .ladi-cart-row .ladi-cart-price span[data-product-variant-id="' + i.product_variant_id + '"]'), o = 0; o < n.length; o++) {
                    ...
                    if (isObjectLadiPage(i.promotion)) {
                        ...
                        isEmptyLadiPage(l) && ((l = document.createElement("span")).className = "price-compare",
                        d.appendChild(l));
                        ...
                        l.innerHTML = u,
                        isEmptyLadiPage(c) && ((c = document.createElement("span")).className = "promotion-name",
                        s.appendChild(c)),
                        c.innerHTML = i.promotion.discount.note
                    } else
                        r.classList.remove("has-promotion"),
                        isEmptyLadiPage(l) || l.parentElement.removeChild(l),
                        isEmptyLadiPage(c) || c.parentElement.removeChild(c)
                }
            }
        }
    }
      ...
      , r = o()
      , d = JSON.stringify(r);
    if (isObjectLadiPage(a.runtime.tmp.info_update_cart_promotion) || (a.runtime.tmp.info_update_cart_promotion = {}),
    !isEmptyLadiPage(t)) {
        var s = []
        ...
        return -1 != [a.const.FORM_CONFIG_TYPE.sapo, a.const.FORM_CONFIG_TYPE.haravan, a.const.FORM_CONFIG_TYPE.shopify].indexOf(a.runtime.shopping_product_type) && t.items.forEach(function(e) {
            ...
            -1 != [a.const.FORM_CONFIG_TYPE.sapo, a.const.FORM_CONFIG_TYPE.haravan].indexOf(a.runtime.shopping_product_type) && (i = {
                store_id: -1,
                product_id: e.product_id,
            ...
            -1 != [a.const.FORM_CONFIG_TYPE.shopify].indexOf(a.runtime.shopping_product_type) && (i = {
                store_id: -1,
                product_id: e.product_id,
                product_variant_id: e.variant_id,
            ...
            if (-1 != [a.const.FORM_CONFIG_TYPE.sapo, a.const.FORM_CONFIG_TYPE.haravan].indexOf(a.runtime.shopping_product_type)) {
                if (i.price = e.price_original,
                isObjectLadiPage(e.properties)) {
                    var c = Object.keys(e.properties);
                    c.length > 0 && (r = e.properties[c[0]],
                    -1 != [a.const.FORM_CONFIG_TYPE.haravan].indexOf(a.runtime.shopping_product_type) && ((r = r.split("-")).shift(),
                    r = (r = r.join("-")).trim()),
                    d = {
                        product_id: e.product_id,
                        product_variant_id: e.variant_id,
            ...
            -1 != [a.const.FORM_CONFIG_TYPE.shopify].indexOf(a.runtime.shopping_product_type) && (i.price = e.original_price,
            e.original_line_price != e.line_price && isArrayLadiPage(e.discounts) && e.discounts.length > 0 && (r = e.discounts[0].title,
            d = {
                product_id: e.product_id,
                product_variant_id: e.variant_id,
            ...
            i.promotion = d,
            s.push(d))),
            -1 != [a.const.FORM_CONFIG_TYPE.haravan, a.const.FORM_CONFIG_TYPE.shopify].indexOf(a.runtime.shopping_product_type) && (i.price = i.price / 100,
            isEmptyLadiPage(i.promotion) || (i.promotion.total = i.promotion.total / 100,
        ...
        -1 != [a.const.FORM_CONFIG_TYPE.wordpress].indexOf(a.runtime.shopping_product_type) && t.data.forEach(function(t) {
            ...
            var i = {
              ...
              , n = t.currency;
            isEmptyLadiPage(n) && (n = a.runtime.currency),
            a.runtime.isClient || (n = window.$rootScope.getStoreCurrency()),
            i.currency = {
                code: n,
                symbol: a.formatCurrency(null, n, !1, !0)
    ...
    if (!0 !== a.runtime.tmp.info_update_cart_promotion[d]) {
        if (isArrayLadiPage(a.runtime.tmp.info_update_cart_promotion[d]))
            return a.runtime.tmp.info_update_cart_promotion[d].forEach(n),
            void a.changeTotalPriceCart();
        if (a.runtime.tmp.info_update_cart_promotion[d] = !0,
                        ...
                        if (200 == e)
                            try {
                                ...
                                if (200 == r.code && isObjectLadiPage(r.data) && isArrayLadiPage(r.data.variants))
                                    return r.data.variants.forEach(n),
                                    a.runtime.tmp.info_update_cart_promotion[d] = r.data.variants,
                    ...
                    if (o.readyState == XMLHttpRequest.DONE) {
                        if (200 == n)
                            try {
                                ...
                                return e && a.runtime.tmp.cart.length > 0 && a.reloadCheckoutWordpress(),
                                a.changeTotalPriceCart(),
                                void (isFunctionLadiPage(i) && i())
                            } catch (t) {}
                        delete a.runtime.tmp.info_update_cart_promotion[d],
...
LadiPageScriptV2.prototype.addCartCookie = function(t, e, i, a, n) {
    ...
    if (-1 != [o.const.FORM_CONFIG_TYPE.sapo, o.const.FORM_CONFIG_TYPE.haravan, o.const.FORM_CONFIG_TYPE.shopify].indexOf(o.runtime.shopping_product_type))
        return -1 != [o.const.FORM_CONFIG_TYPE.sapo].indexOf(o.runtime.shopping_product_type) && (d = {
            "Content-Type": "application/x-www-form-urlencoded",
            "X-Requested-With": "XMLHttpRequest"
        },
        s = {
            variantId: e.product_variant_id,
            quantity: e.quantity
        },
        s = Object.keys(s).reduce(function(t, e) {
            return t.push(e + "=" + encodeURIComponent(s[e])),
            t
        }, []).join("&")),
        -1 != [o.const.FORM_CONFIG_TYPE.haravan].indexOf(o.runtime.shopping_product_type) && (d = {
            "Content-Type": "application/x-www-form-urlencoded",
            "X-Requested-With": "XMLHttpRequest"
        },
        s = {
        ...
        -1 != [o.const.FORM_CONFIG_TYPE.shopify].indexOf(o.runtime.shopping_product_type) && (d = {
            "Content-Type": "application/x-www-form-urlencoded",
            "X-Requested-With": "XMLHttpRequest"
        },
        s = {
        ...
        void this.sendRequest("POST", window.location.origin + "/cart/add.js", s, !0, d, function(t, e, d) {
            if (d.readyState == XMLHttpRequest.DONE) {
                if (200 == e)
                    try {
                        if (r = JSON.parse(t),
                        !isEmptyLadiPage(r.id))
                            return isFunctionLadiPage(i) && i(),
                            isFunctionLadiPage(n) && n(),
                            o.reloadPriceDiscount(),
                            void o.reloadFeeShipping()
                    } catch (t) {}
                isFunctionLadiPage(a) && a(r),
                isFunctionLadiPage(n) && n()
            }
        });
    if (-1 == [o.const.FORM_CONFIG_TYPE.wordpress].indexOf(o.runtime.shopping_product_type)) {
        ...
        isEmptyLadiPage(l) || (d["cart-token"] = l);
        var c = e.quantity;
        s = JSON.stringify({
            type: "LP",
            product_variant_id: e.product_variant_id,
                ...
                if (200 == e)
                    try {
                        if (200 == (r = JSON.parse(t)).code)
                            return window.ladi("_cart_token").set_cookie(r.data.cart_token, 30),
        ...
        this.sendRequest("POST", window.location.origin + "/ladipage/api?action=cart_add&product_id=" + e.product_id + "&variant_id=" + e.product_variant_id + "&qty=" + e.quantity, s, !0, d, function(t, e, d) {
            if (d.readyState == XMLHttpRequest.DONE) {
                if (200 == e)
                    try {
                        if (200 == (r = JSON.parse(t)).code)
                            return o.updateCartPromotion(r),
                            isFunctionLadiPage(i) && i(),
                            isFunctionLadiPage(n) && n(),
                            o.reloadPriceDiscount(),
                            void o.reloadFeeShipping()
...
LadiPageScriptV2.prototype.updateCartCookie = function(t, e, i, a, n) {
    ...
    if (-1 == [o.const.FORM_CONFIG_TYPE.sapo, o.const.FORM_CONFIG_TYPE.haravan, o.const.FORM_CONFIG_TYPE.shopify].indexOf(o.runtime.shopping_product_type)) {
        if (-1 != [o.const.FORM_CONFIG_TYPE.wordpress].indexOf(o.runtime.shopping_product_type))
            return l = window.location.origin + "/ladipage/api?action=cart_update_item_qty&cart_item_key=" + t.cart_item_key + "&qty=" + t.quantity,
        ...
        isEmptyLadiPage(c) || (s["cart-token"] = c);
        var u = t.quantity;
        d = JSON.stringify({
            product_variant_id: t.product_variant_id,
            quantity: u
        ...
        if (-1 != [o.const.FORM_CONFIG_TYPE.sapo].indexOf(o.runtime.shopping_product_type) && (l = window.location.origin + "/cart/change.js",
        s = {
            "Content-Type": "application/x-www-form-urlencoded",
            "X-Requested-With": "XMLHttpRequest"
        },
        d = {
            variantId: t.product_variant_id,
            quantity: t.quantity
        },
        ...
        -1 != [o.const.FORM_CONFIG_TYPE.haravan].indexOf(o.runtime.shopping_product_type) && (l = window.location.origin + "/cart/update.js",
        s = {
            "Content-Type": "application/x-www-form-urlencoded",
            "X-Requested-With": "XMLHttpRequest"
        },
        d = o.runtime.tmp.cart.reduce(function(i, a) {
            var n = a.quantity;
            return (e || a.product_variant_id == t.product_variant_id) && (n = t.quantity),
...
LadiPageScriptV2.prototype.getMessageNameProduct = function(t, e) {
    ...
    return isObjectLadiPage(t) && (t.product_type == this.const.PRODUCT_TYPE.event ? i = this.const.LANG.TICKET : t.product_type == this.const.PRODUCT_TYPE.service && (i = this.const.LANG.SERVICE)),
    e || (i = i.toLowerCase()),
    i
}
,
          ...
          , _ = function(t, e, i, a, n, r) {
            ...
            a["option.input_type"] == o.const.INPUT_TYPE.product_variant) {
                                ...
                                for (var l = s.querySelectorAll('[data-variant="true"]'), c = 0; c < l.length; c++)
                                    if (l[c].id != d.id) {
                                        var u = o.runtime.eventData[l[c].id]
                                          ...
                                          , g = null
                                          , _ = 0;
                                        if (u["option.product_variant_type"] == o.const.PRODUCT_VARIANT_TYPE.combobox && (m = n.variants[a],
                                        isObjectLadiPage(m) && isStringLadiPage(m.option_ids)))
                                            for (g = m.option_ids.split("/"),
                                            _ = 0; _ < g.length; _++)
                                                p = l[c].querySelector('select[data-product-option-id="' + g[_] + '"]'),
                                                isEmptyLadiPage(p) || (p.value = m["option" + (_ + 1)]);
                                        if (u["option.product_variant_type"] == o.const.PRODUCT_VARIANT_TYPE.label && (m = n.variants[a],
                                        isObjectLadiPage(m) && isStringLadiPage(m.option_ids)))
                                            for (g = m.option_ids.split("/"),
                                            _ = 0; _ < g.length; _++)
                                                p = l[c].querySelector('.ladi-form-label-container[data-product-option-id="' + g[_] + '"]'),
                                                isEmptyLadiPage(p) || o.runtime.tmp.updateLabelValue(p, m["option" + (_ + 1)]);
                                        if (u["option.product_variant_type"] == o.const.PRODUCT_VARIANT_TYPE.combined) {
                                            if (p = l[c].querySelector("select.ladi-form-control"),
                                            !isEmptyLadiPage(i)) {
                ...
                o.showParentVisibility(e, function() {
                    ...
                    for (g = 0; g < _.length; g++)
                        m[_[g].getAttribute("data-store-id") + "_" + _[g].getAttribute("data-product-id") + "_" + _[g].getAttribute("data-product-option-id")] = u(_[g]);
                    e.innerHTML = d;
                    for (var y = e.querySelectorAll("select.ladi-form-control"), f = null, v = null, P = 0; P < y.length; P++)
                        ...
                        isNullLadiPage(f) && (v = y[P].querySelector("option"),
                        isEmptyLadiPage(v) || (f = v.getAttribute("value"))),
                        y[P].value = f;
                    var h = e.querySelectorAll(".ladi-form-label-container");
                    for (P = 0; P < h.length; P++) {
                        for (var L = h[P].querySelectorAll(".ladi-form-label-item"), E = 0; E < L.length; E++)
                            o.tapEventListener(L[E], p);
                        f = m[h[P].getAttribute("data-store-id") + "_" + h[P].getAttribute("data-product-id") + "_" + h[P].getAttribute("data-product-option-id")],
                        isNullLadiPage(f) && (v = L[1],
                        isEmptyLadiPage(v) || (f = l(v))),
                        c(h[P], f)
                    }
                    if (o.updateProductVariantSelectOptionFirst(i, a, e),
                    a["option.product_variant_type"] != o.const.PRODUCT_VARIANT_TYPE.combined && (e.style.setProperty("height", "auto"),
                    n = e.clientHeight,
                    e.style.removeProperty("height"),
                    n > 0 && t != n)) {
                        e.style.setProperty("height", n + "px");
                        var b = o.findAncestor(e, "ladi-form");
                        isEmptyLadiPage(b) || (b = o.findAncestor(b, "ladi-element"),
                        o.updateHeightElement(!0, e, b, t, n))
                    }
                })
            }
            if (a["option.input_type"] == o.const.INPUT_TYPE.number) {
                ...
                m.addEventListener("input", g),
                o.fireEvent(m, "input");
                var y = e.querySelectorAll(".button")[0]
                  , f = e.querySelectorAll(".button")[1];
                if (isEmptyLadiPage(y) || isEmptyLadiPage(f))
                    return;
            ...
            if ("button" == a.type && (a["option.is_buy_now"] || a["option.is_add_to_cart"])) {
                var v = function() {
                    ...
                    isObjectLadiPage(i["option.data_action"]))) {
                        ...
                        a.action_type = o.const.ACTION_TYPE.action,
                        t.push(a)
                    }
                    t.forEach(function(t) {
                        t.action_type == o.const.ACTION_TYPE.action && (t.type == o.const.DATA_ACTION_TYPE.popup_cart && (window.ladi("POPUP_CART").show(),
                        o.runEventTracking(e.id, {
                            is_form: !1
                        })),
                        t.type == o.const.DATA_ACTION_TYPE.popup_checkout && (o.runtime.shopping_third_party ? o.getThirdPartyCheckoutUrl(!0) : window.ladi("POPUP_CHECKOUT").show(),
                        o.runEventTracking(e.id, {
                            is_form: !1
                        })))
                    })
          ...
          , y = function(t, e, i, a, n, r) {
            ...
            if (d)
                if (a && isEmptyLadiPage(i))
                    l = "";
                else if (!isEmptyLadiPage(e["option.product_id"]) && s === (l = (c = o.generateProductKey(!0, s, !0, e, !0, i, null, function(o) {
                    y(t, e, i, a, n, r)
                })).value))
                    return;
            var u = e.type
              , p = null
              , m = null;
            if (d && "headline" == u && (m = t.getElementsByClassName("ladi-headline")[0],
            isEmptyLadiPage(m) || (m.innerHTML = isNullLadiPage(l) ? "" : l)),
            d && "paragraph" == u && (m = t.getElementsByClassName("ladi-paragraph")[0],
            isEmptyLadiPage(m) || (m.innerHTML = isNullLadiPage(l) ? "" : l)),
            d && "image" == u) {
            ...
            if ("gallery" == u) {
                ...
                if (isEmptyLadiPage(P) || P.style.removeProperty("left"),
                d) {
                    ...
                    for (; h.length > l.length; )
                        h[h.length - 1].parentElement.removeChild(h[h.length - 1]);
                    ...
                    for (w = t.querySelectorAll(".ladi-gallery > .ladi-gallery-control"),
                    T = 0; T < w.length; T++)
                        l.length <= 1 ? w[T].style.setProperty("display", "none") : w[T].style.removeProperty("display");
                    for (w = t.querySelectorAll(".ladi-gallery > .ladi-gallery-view"),
                    T = 0; T < w.length; T++)
                        l.length <= 1 ? w[T].style.setProperty("height", "100%") : w[T].style.removeProperty("height");
                    l.forEach(function(e, i) {
                        p = e.src,
                        isEmptyLadiPage(v) || (p = o.getOptimizeImage(e.src, v.clientWidth, v.clientHeight, !0, !1, !1, o.runtime.isClient));
            ...
            "countdown" == u && o.runtime.tmp.runOptionCountdown(t.id, t, u, e["option.countdown_type"], e["option.countdown_minute"], e["option.countdown_daily_start"], e["option.countdown_daily_end"], e["option.countdown_endtime"])
        }
          , f = function(t, e) {
            var c = p * m
            ...
            if (isObjectLadiPage(u) && isArrayLadiPage(u.products)) {
                ...
                if (isEmptyLadiPage(b) || b.classList.remove("opacity-0"),
                ...
                v.getAttribute("data-page") == v.getAttribute("data-max-page") && (l == o.const.COLLECTION_TYPE.readmore && (isEmptyLadiPage(w) || w.classList.add("opacity-0")),
                l == o.const.COLLECTION_TYPE.carousel && (isEmptyLadiPage(A) || A.classList.add("opacity-0"))),
                P < i)
                    return;
                ...
                for (var x = k.getElementsByClassName("ladi-collection-page"); x.length < i; ) {
                    var D = document.createElement("div");
                    D.className = "ladi-collection-page",
                    k.appendChild(D)
                }
                var R = x[i - 1]
                ...
                if (F.length != u.products.length)
                    for (; F.length > 0; )
                        F[0].parentElement.removeChild(F[0]);
                var q = function(t, i, a, n, l, c) {
                    ...
                    for (var u = function(t, e) {
                        ...
                        isEmptyLadiPage(m) || (u(t[p], m),
                        m["option.product_type"] = r,
                        m["option.ladisale_store_id"] = d,
                        m["option.product_tag_id"] = s,
                        m["option.product_id"] = i.id,
                        a && (isFunctionLadiPage(o.runtime.tmp.runOptionAction) && o.runtime.tmp.runOptionAction(t[p], t[p].id, m.type, m),
                ...
                for (O = 0; O < u.products.length; O++)
                    isArrayLadiPage(u.products[O].options) && u.products[O].options.length > S && (S = u.products[O].options.length);
                for (v.setAttribute("data-max-option-length", S),
                O = 0; O < u.products.length; O++)
                    if (!(F.length > O)) {
                        var B = document.createElement("div");
                        B.className = I.className,
                        R.appendChild(B),
                        B.innerHTML = I.innerHTML;
                        for (var M = B.getElementsByClassName("ladi-element"); isArrayLadiPage(u.products[O].options) && u.products[O].options.length < S; )
                            u.products[O].options.push({
                                is_tmp: !0
                            });
                        q(M, u.products[O], !0, null, !1, !1)
                    }
                h && (R.classList.add("last"),
                L && R.classList.add("not-full")),
                l == o.const.COLLECTION_TYPE.carousel && function(t) {
                    var e = document.getElementById(t);
                    if (!isEmptyLadiPage(e) && e.hasAttribute("data-page")) {
                        var i = "0"
                          ...
                          , c = ""
                          , u = "";
                        l > 0 ? (n = "calc(" + a + " * " + d.length + " - (" + a + " / " + m + " * " + l + ") + calc(" + g + "px / " + m + " * " + s.length + "))",
                        r > 1 && (r != d.length ? i = "calc(-" + a + " * " + (r - 1) + ")" : (i = "calc(-" + a + " * " + (r - 1) + " + (" + a + " / " + m + " * " + l + "))",
                        u = "margin-left: calc(-" + g + "px / " + m + " * " + s.length + ");")),
                ...
                n && l == o.const.COLLECTION_TYPE.readmore && function(t) {
                    var e = document.getElementById(t);
                    if (!isEmptyLadiPage(e)) {
                        ...
                        if (e.hasAttribute("data-max-page")) {
                            ...
                            if (p == r)
                                ...
                                d -= parseFloatLadiPage(g * (p - r) / p) || 0,
                        ...
                        if (s != l) {
                            ...
                            isEmptyLadiPage(c) && (c = o.findAncestor(e.parentElement, "ladi-section")),
                            o.updateHeightElement(!0, e, c, s, l)
                        }
                    }
                }(t),
                o.runEventScroll(),
...
var lightbox_run = function(t, e, i, a, n, o, r, d) {
    ...
    if (!isEmptyLadiPage(s)) {
        ...
        var y = function() {
            ...
            !isEmptyLadiPage(m)) {
                ...
                if (_ = s.getElementsByClassName("lightbox-close")[0],
                !isEmptyLadiPage(_)) {
        ...
        var v = "load";
        if (i && o == LadiPageScript.const.VIDEO_TYPE.direct && (v = "loadedmetadata"),
        g && (m.addEventListener(v, f),
        m.addEventListener("error", f)),
        i) {
            var P = e;
            o == LadiPageScript.const.VIDEO_TYPE.youtube && (e = null,
            P = r),
            g ? LadiPageScript.runEventPlayVideo(n, o, P, !1, !1, !0, !1, d, !1, function(t) {
                isEmptyLadiPage(t) ? f() : (t.addEventListener(v, f),
                t.addEventListener("error", f))
            }) : f()
        }
        d || s.style.setProperty("display", "block"),
        ...
        var h = function() {
          ...
          , L = 0;
        h() ? (L = window.scrollY,
        LadiPageScript.runtime.tmp.bodyScrollY = L) : L = LadiPageScript.runtime.tmp.bodyScrollY;
        var E = function() {
            l(),
        ...
        !d) {
            ...
            b += "top: -" + L + "px !important;",
            b += "}",
            LadiPageScript.createStyleElement("style_lightbox", b)
        }
        isEmptyLadiPage(s.getAttribute("data-load-event")) && (s.setAttribute("data-load-event", !0),
        s.addEventListener("click", function(t) {
            t.stopPropagation(),
            t.target.id == s.id && (_ = s.getElementsByClassName("lightbox-close")[0],
  ...
  , lightbox_iframe = function(t, e, i, a, n, o) {
    if (!isEmptyLadiPage(t)) {
        ...
        isEmptyLadiPage(l) || "IFRAME" != l.tagName || (s = l.src,
        i = l.id || i,
        l.removeAttribute("src"),
        l.setAttribute("style", r),
        l.classList.add("lightbox-item"),
        d = l.outerHTML),
        lightbox_run(d, s, e, !0, i, a, n, o)
    }
}
    ...
    if (!isEmptyLadiPage(i))
        if (LadiPageScript.runtime.has_popupx)
            ...
            var r = isObjectLadiPage(LadiPageScript.runtime.story_page)
                ...
                if (0 != d) {
                    ...
                    if (p) {
                        ...
                        (m = function() {
                            g = a(l += 20, n, d, c),
                            _(g),
                            l < c ? LadiPageScript.runtime.tmp.scroll_timeout_id = LadiPageScript.runTimeout(m, 20) : _(i)
                        }
                        )()
                }
            }
              ...
              , c = null
              , u = null;
            e ? r ? i.scrollIntoView() : (l = s(window),
            window.scrollTo({
                top: l.scrollTop
            })) : LadiPageScript.runTimeout(function() {
                var t;
                ...
                LadiPageScript.runtime.story_page.type == LadiPageScript.const.STORY_PAGE.vertical && (l = s(u),
                d("top", u, l.scrollTop))) : (u = window,
                l = s(u),
    ...
    if (!isEmptyLadiPage(a)) {
        ...
        if (4 == s.length)
            ...
            for (r = 0; r < l.length; r++)
                if (isNullLadiPage(t))
                    isObjectLadiPage(i) && i.only_text ? n.push(l[r].innerText) : n.push(l[r].innerHTML);
                else if (l[r].innerHTML = t,
                !isEmptyLadiPage(e)) {
            ...
            for (r = 0; r < u.length; r++)
                ...
                "checkbox" == u[r].getAttribute("type").toLowerCase() && (o = !0)) : (P = !1,
            ...
            for (r = 0; r < p.length; r++)
                if (isNullLadiPage(t)) {
                    ...
                    (h = h || "").startsWith('url("') && (h = h.substring('url("'.length)),
                    h.endsWith('")') && (h = h.substring(0, h.length - '")'.length)),
                    n.push(h)
                ...
                if (isNullLadiPage(t))
                    ...
                    if (isEmptyLadiPage(A))
                        ...
                        if (b["option.video_type"] == LadiPageScript.const.VIDEO_TYPE.youtube) {
                            ...
                            !isEmptyLadiPage(C) && isFunctionLadiPage(C.loadVideoById) && (C.loadVideoById(w, 0),
                            C.seekTo(0),
                            O = !0)
                        }
            ...
            for (r = 0; r < _.length; r++)
                ...
                "true" == a.getAttribute("data-multiple") && (o = !0)) : (P = !1,
                -1 != d.indexOf(_[r].getAttribute("data-value")) && (P = !0),
                P ? _[r].classList.contains("selected") || _[r].click() : _[r].classList.contains("selected") && _[r].click())
        }
    ...
    if (!isEmptyLadiPage(e) && !e.classList.contains("ladi-section")) {
        ...
        if (isEmptyLadiPage(i)) {
            ...
            if ("none" == getComputedStyle(e).display) {
                if (a || t)
                    if (a && o) {
                        if (s = parseFloatLadiPage(e.getAttribute("data-timeout-id")) || null,
                        !isEmptyLadiPage(s))
                            return;
    ...
    if (!isEmptyLadiPage(i)) {
        ...
        if (t) {
            if (i.getElementsByClassName("ladi-popup").length > 0) {
                var l = !0;
                if (isObjectLadiPage(e) && !isNullLadiPage(e.checkHidePopupOther) && (l = e.checkHidePopupOther),
                l) {
...
LadiPageLibraryV2.prototype.showDropbox = function(t, e, i) {
    ...
    if (!(isEmptyLadiPage(a) || "true" != a.getAttribute("data-dropbox") || i && a.getAttribute("data-from-doc-id") == t.id && "true" != a.getAttribute("data-dropbox-backdrop") && "block" == getComputedStyle(a).display)) {
        ...
        if (i && !isEmptyLadiPage(d))
            d = "#" + a.id + ":before {" + d + "}",
            LadiPageScript.createStyleElement(s, d);
        else {
...
LadiPageLibraryV2.prototype.set_style = function(t, e, i) {
    ...
    if (!isEmptyLadiPage(a)) {
        ...
        isEmptyLadiPage(e.background_color) || (s.background = "none",
        s["background-color"] = e.background_color),
        ...
        if (!isEmptyLadiPage(m)) {
            ...
            document.querySelectorAll(v()).length > 0 && (i && (y = !0,
            g += v() + " {transition: all 150ms linear 0s;}"),
            c += v(o) + " {" + m + "}")
        }
        ...
        f(p) || (u += p)),
        isEmptyLadiPage(u) || (l = [".ladi-group", ".ladi-accordion", ".ladi-popup", ".ladi-image", ".ladi-gallery", ".ladi-button", ".ladi-button-group", ".ladi-headline", ".ladi-paragraph", ".ladi-list-paragraph", ".ladi-line", ".ladi-box", ".ladi-collection", ".ladi-tabs", ".ladi-shape", ".ladi-video", ".ladi-form", ".ladi-carousel", ".ladi-html-code", ".ladi-frame", ".ladi-table", ".ladi-survey", ".ladi-combobox", ".ladi-countdown", ".ladi-notify", ".ladi-spin-lucky"],
        f(u) || (_ += u)),
        isEmptyLadiPage(_) || (l = [""],
        f(_)),
...
(LadiPageAppV2 = LadiPageAppV2 || function() {}
    ...
    return i.prototype.run = function(e, i) {
        ...
        !isEmptyLadiPage(l) || !isEmptyLadiPage(c)) {
                  ...
                  , l = function() {
                    if (i + 1 < t.length) {
                        ...
                        LadiPageScript.runtime.tmp.timeout_notify[e] = LadiPageScript.runTimeout(function() {
                            v(),
                            LadiPageScript.runtime.tmp.timeout_notify[e] = LadiPageScript.runTimeout(h, 500)
                        }, g)
                    } else
                        P(t)
                };
            ...
            isEmptyLadiPage(l) || LadiPageScript.sendRequest("GET", "https://docs.google.com/spreadsheets/d/" + l + "/gviz/tq?tqx=out:json", null, !0, null, function(t, e, i) {
    ...
    i.prototype.run = function(e, i) {
        ...
        if (!isEmptyLadiPage(n) || !isEmptyLadiPage(o)) {
            ...
            u.addEventListener("click", function(t) {
                ...
                !g)
                    if ((l = a(e)) >= s)
                        LadiPageScript.showMessage(LadiPageScript.const.LANG.GAME_MAX_TURN_MESSAGE.format(s));
                    else {
                        g = !0;
                        var i = []
                          , o = 0
                        ...
                        if (isEmptyLadiPage(m))
                            ...
                            "NEXT_TURN" != m.value.toUpperCase() && (l++,
                            window.ladi("_total_turn_" + e).set_cookie(l, 1));
                            LadiPageScript.runTimeout(function() {
                                "NEXT_TURN" == m.value.toUpperCase() ? isEmptyLadiPage(m.text) || LadiPageScript.showMessage(m.text) : (LadiPageScript.setDataReplaceStr("coupon", m.value),
